...
include 'includes/conn.php';
 if(($_SESSION['elcthospitallevel']!='admin')&&(($_SESSION['elcthospitallevel']!='store manager'))&&(($_SESSION['elcthospitallevel']!='lab technician'))){
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index">Home</a></li>
                                  <li class="breadcrumb-item active"><a href="#">Lab Stock</a></li>
                        </ol>
                    </div>
                </div>
       		<div class="row">
       		<div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Lab Stock</h4>
                            </div>
                            <div class="card-body">
                            ...
                            $checkitem= mysqli_query($con, "SELECT * FROM ordereditems WHERE item_id='$inventoryitem_id' AND section='lab'") or die(mysqli_error($con));                                                           
                       ...
                       $getotherstock= mysqli_query($con, "SELECT * FROM ordereditems WHERE item_id='$inventoryitem_id' AND section='lab'") or die(mysqli_error($con));
