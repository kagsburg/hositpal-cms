...
?>
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="#">SI Units</a></li>
                        </ol>
                    </div>
                </div>
       		<div class="row">
       		<div class="col-lg-5">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add SI Unit</h4>
                            </div>
                            <div class="card-body">
              ...
              mysqli_query($con,"INSERT INTO units(measurement,status) VALUES('$measurement',1)") or die(mysqli_error($con));
             
echo '<div class="alert alert-success"><i class="fa fa-check"></i>Unit successfully added</div>';
                                 }
                            }
   ...
   <div class="form-group">
                     ...
                     <table id="example5" class="display" style="min-width: 600px">
                        ...
                        <td>
                         ...
                         <a href="removeunit?id=<?php echo $measurement_id; ?>" class="btn btn-xs btn-danger" onclick="return confirm_delete<?php echo $measurement_id;?>()">Remove</a>
...
function confirm_delete<?php echo $measurement_id; ?>() {
  return confirm('You are about To Remove this item. Are you sure you want to proceed?');
                      ...
                      <div class="modal fade" id="basicModal<?php echo $measurement_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
          aria-hidden="true">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                           ...
                           <div class="modal-body">
                               <form action="editunit?id=<?php echo $measurement_id; ?>" method="POST">
                                    <div class="form-group">
