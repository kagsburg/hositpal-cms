                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="admitted">Admitted </a></li>
                            <li class="breadcrumb-item active"><a href="#">Add Progress</a></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <form method="post" name='form' class="form" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-lg-4"><label class="control-label">Tovalue</label>
