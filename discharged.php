...
?>
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="discharged">Discharged Patients</a></li>
                        </ol>
                    </div>
                </div>
       		<div class="row">
       		<div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">All Discharged Patients</h4>
                            </div>
                            <div class="card-body">
               ...
               $getadmitted= mysqli_query($con,"SELECT * FROM admitted WHERE status=2 AND admin_id='".$_SESSION['elcthospitaladmin']."' ORDER BY admitted_id DESC");
                                     }  if(($_SESSION['elcthospitallevel']=='doctor')){
               $getadmitted= mysqli_query($con,"SELECT * FROM admitted WHERE status=2 ORDER BY admitted_id DESC");
                                     }
  ...
  if(strlen($patient_id)>=5){
      $pin=$patient_id;
                                      ...
                                      <td>     
                                       <a href="admission?id=<?php echo $patient_id; ?>" class="btn btn-success btn-xs">View Details</a>  
                                      <?php 
