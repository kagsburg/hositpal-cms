...
if (($_SESSION['elcthospitallevel'] != 'admin')) {
    ...
    if (isset($_POST['charge'])) {
        ...
        if (!empty($errors)) {
            ...
            mysqli_query($con, "INSERT INTO insuredradiotypes(investigationtype_id,insurancecompany_id,charge,status) VALUES('$id','$company','$charge','1')") or die(mysqli_error($con));
