                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            $anareport = mysqli_query($con, "SELECT * FROM anaesthesiareport WHERE anareport_id  = '$anareport_id'");
                        ...
                        ?>
                            ...
                            <div class="card-body">
                                ...
                                <hr>
                                <h3> Intra-Operative Report</h3>
                                <h3> Monitoring </h3>
                                <div class="row">
                                    <?php
                                    // get patient labs
                                    $labs = mysqli_query($con, "SELECT * FROM anaesthesiareportmont WHERE anaesthesiareport2_id  = '$anareport2_id'");
                                    if (mysqli_num_rows($labs) > 0) {
                                        while ($lab = mysqli_fetch_array($labs)) {
                                            $labname = $lab['type'];
                                            $labvalue = $lab['value'];
                                ...
                                <div class="row">
                                    <?php
                                    // get patient labs
                                    $labs = mysqli_query($con, "SELECT * FROM anaesthesiareportven WHERE anaesthesiareport2_id  = '$anareport2_id'");
                                    if (mysqli_num_rows($labs) > 0) {
                                        while ($lab = mysqli_fetch_array($labs)) {
                                            $labname = $lab['type'];
                                            $labvalue = $lab['value'];
                                ...
                                <h3> Regional anaesthesia </h3>
                                <div class="row">
                                    <?php
                                    // get patient labs
                                    $labs = mysqli_query($con, "SELECT * FROM anaesthesiareportreg WHERE anaesthesiareport2_id  = '$anareport2_id'");
                                    if (mysqli_num_rows($labs) > 0) {
                                        while ($lab = mysqli_fetch_array($labs)) {
                                            $labname = $lab['type'];
                                            $labvalue = $lab['value'];
                                ...
                                <div class="row">
                                    <?php
                                    // get patient labs
                                    $labs = mysqli_query($con, "SELECT * FROM anaesthesiareportreext WHERE anaesthesiareport2_id  = '$anareport2_id'");
                                    if (mysqli_num_rows($labs) > 0) {
                                        while ($lab = mysqli_fetch_array($labs)) {
                                            $labname = $lab['type'];
                                            $labvalue = $lab['value'];
