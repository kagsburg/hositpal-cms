...
<?php 
         ...
         $addemployee=  mysqli_query($con,"UPDATE inventoryitems SET tradename='$tradename',subcategory_id='$subcategory',unitprice='$unitprice',measurement_id='$unitmeasurement',minimum='$minimum' WHERE inventoryitem_id='$id'");
