                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add Patient : PART THREE (Medication Information)</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <?php
                                    if (isset($_POST['bloodgroup'], $_POST['weight'], $_POST['height'], $_POST['allergies'], $_POST['diseases'], $_POST['pregnancies'])) {
                                        ...
                                        mysqli_query($con, "UPDATE patients SET bloodgroup='$bloodgroup',weight='$weight',height='$height',allergies='$allergies',diseases='$diseases',pregnancies='$pregnancies',level=3 WHERE patient_id='" . $_SESSION['patientreg'] . "'") or die(mysqli_error($con));
                                        if (isset($_POST['month'], $_POST['year'])) {
                                            $month = $_POST['month'];
                                            $year = $_POST['year'];
                                            $allsurgeries = sizeof($month);
                                            for ($i = 0; $i < $allsurgeries; $i++) {
                                                mysqli_query($con, "INSERT INTO surgeryhistory(month,year,patient_id,status) VALUES('$month[$i]','$year[$i]','" . $_SESSION['patientreg'] . "','1')") or die(mysqli_error($con));
                                            }
                                        }
                                    ?>
                                        <script type="text/javascript">
                                            window.location = "addpatient3.php";
                                        </script>
                                    <?php
                                        echo '<div class="alert alert-success">Patient Information Successfully Added.Click <a href="addpatient4.php">here</a> to proceed</div>';
                                    }
                                    ?>
