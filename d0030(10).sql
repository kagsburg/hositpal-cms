...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 14, 2023 at 11:31 PM
...
CREATE TABLE `acts` (
  ...
  `explain_death` text DEFAULT NULL,
  ...
  `mother_condition` text DEFAULT NULL,
...
INSERT INTO `acts` (`act_id`, `admission_id`, `deathdate`, `location`, `type`, `icd`, `time`, `duration`, `medicaloperation`, `operation_date`, `operation_reason`, `death_investigated`, `death_verifyed`, `death_occurred`, `explain_death`, `placeddeathoccurred`, `unborn_twins`, `born_already_dead`, `hildren_24`, `living_duration`, `weight_child`, `pregnancy_period`, `mother_age`, `mother_condition`, `admin_id`, `timestamp`, `status`) VALUES
(1, 10, '2023-07-28', '', 'immediate', 89, '12:03:00', '', 'yes', 1689282000, 'Nosal failure', 'yes', 'yes', 'Illness,attacked,', '', 'in a street,,', 'no', 'no', 'Unk', '', 0, 0, 0, '', 165, 1690235583, 1);
...
(1, 4, 'normal', 'insurance', 1686047230, 1691677886, 163, 2, NULL),
(2, 2, 'normal', 'insurance', 1686930190, 1688665875, 163, 2, NULL),
(3, 6, 'normal', 'cash', 1687458439, 1688406809, 163, 2, NULL),
(4, 7, 'normal', 'cash', 1687498767, 1688665895, 163, 2, NULL),
(5, 8, 'normal', 'cash', 1687500512, 1688406816, 163, 2, NULL),
(6, 8, 'normal', 'insurance', 1687769968, 1688146078, 163, 2, NULL),
(7, 9, 'normal', 'cash', 1687936708, 1688206594, 163, 2, NULL),
(8, 9, 'normal', 'cash', 1688206623, 1688219912, 163, 2, NULL),
(9, 9, 'normal', 'cash', 1688304904, 1688323590, 163, 2, NULL),
(10, 9, 'normal', 'cash', 1688323607, 0, 163, 1, NULL),
(13, 7, 'normal', 'insurance', 1688572768, 1688665886, 163, 2, NULL),
(11, 8, 'normal', 'insurance', 1688408150, 1688665901, 163, 2, NULL),
(12, 7, 'normal', 'insurance', 1688411140, 1688665881, 163, 2, NULL),
(14, 6, 'normal', 'cash', 1688666020, 0, 163, 1, NULL),
(15, 7, 'normal', 'insurance', 1690305127, 1690733309, 163, 2, NULL),
(16, 8, 'normal', 'emergency', 1690823280, 1691678044, 163, 2, NULL),
(17, 2, 'normal', 'insurance', 1691678252, 0, 163, 1, NULL),
(18, 8, 'emergency', 'cash postpaid', 1691846718, 0, 163, 1, NULL);
...
(1, 14, 19, '50000', 1688850000, 0, 165, 1),
(3, 10, 12, '120000', 1689714000, 1689973200, 165, 2);
...
(1, 9, 'Very sick', 'Petetr', '89', '23', '', 'Done very well', 'no', 177, 'THE PATIENT IS READY FOR THE OPERATION', '2023-07-21', '09:27:00', 2),
(2, 9, 'doing this procedure', 'Doctor', '89', '23', '', 'Done very well', 'no', 177, 'patient is ready for operation', '2023-07-21', '15:53:57', 2);
...
--
-- Dumping data for table `anaesthesiareport2`
--

INSERT INTO `anaesthesiareport2` (`anareport2_id`, `admission_id`, `surgeon`, `admin_id`, `comment`, `date`, `time`, `status`) VALUES
(1, 10, 165, 177, 'patient is very okay', '2023-07-21', '18:25:13', 1);
...
--
-- Dumping data for table `anaesthesiareportgen`
--

INSERT INTO `anaesthesiareportgen` (`id`, `anaesthesiareport2_id`, `type`, `value`) VALUES
(1, 1, 'DFR', '34'),
(2, 1, 'ER', '3');
...
--
-- Dumping data for table `anaesthesiareportmont`
--

INSERT INTO `anaesthesiareportmont` (`id`, `anaesthesiareport2_id`, `type`, `value`) VALUES
(1, 1, 'ECG', '32'),
(2, 1, 'WE', '334');
...
--
-- Dumping data for table `anaesthesiareportreext`
--

INSERT INTO `anaesthesiareportreext` (`id`, `anaesthesiareport2_id`, `type`, `value`) VALUES
(1, 1, 'RTX', 'TRUE'),
(2, 1, 'RTY', 'TURE');
...
--
-- Dumping data for table `anaesthesiareportreg`
--

INSERT INTO `anaesthesiareportreg` (`id`, `anaesthesiareport2_id`, `type`, `value`) VALUES
(1, 1, 'RG', 'TRUE'),
(2, 1, 'RG', 'TRUE');
...
--
-- Dumping data for table `anaesthesiareportven`
--

INSERT INTO `anaesthesiareportven` (`id`, `anaesthesiareport2_id`, `type`, `value`) VALUES
(1, 1, 'DES', 'TRUE'),
(2, 1, 'SD', 'TRUE');
...
INSERT INTO `bills` (`bill_id`, `patient_id`, `admission_id`, `patientsque_id`, `type`, `type_id`, `amount`, `payment_method`, `status`, `created_at`, `updated_at`) VALUES
(1, 4, NULL, NULL, 'unselective', 1363, 2000, 'insurance', 4, '2023-05-15 13:45:34', '2023-08-10 14:31:26'),
(2, 4, 1, 153, 'medical_service', 67, 4000, 'insurance', 4, '2023-06-06 10:27:10', '2023-08-10 14:31:26'),
(3, 2, NULL, NULL, 'unselective', 1363, 2000, 'insurance', 4, '2023-06-16 15:32:38', '2023-07-06 17:51:15'),
(4, 2, 2, 154, 'medical_service', 68, 5000, 'insurance', 4, '2023-06-16 15:43:10', '2023-07-06 17:51:15'),
(5, 3, NULL, NULL, 'unselective', 1363, 1500, 'credit', 0, '2023-06-16 15:53:05', '2023-06-23 05:25:28'),
(6, 2, 2, 157, 'lab', 31, 11000, 'cash', 4, '2023-06-17 11:19:34', '2023-07-06 17:51:15'),
(7, 2, 2, 158, 'radiography', 18, 6000, 'cash', 4, '2023-06-17 11:19:34', '2023-07-06 17:51:15'),
(8, 5, NULL, NULL, 'unselective', 1363, 1500, 'cash', 2, '2023-06-17 11:32:53', '2023-06-23 05:57:31'),
(9, 6, NULL, NULL, 'unselective', 1363, 1200, 'cash', 4, '2023-06-22 18:21:47', '2023-07-03 17:53:29'),
(10, 6, 3, 159, 'medical_service', 69, 6000, 'cash', 4, '2023-06-22 18:27:19', '2023-07-03 17:53:29'),
(11, 6, 3, 160, 'radiography', 19, 0, 'cash', 5, '2023-06-22 18:36:36', '2023-07-03 17:51:27'),
(12, 7, NULL, NULL, 'unselective', 1363, 1200, 'cash', 4, '2023-06-23 05:35:57', '2023-07-03 17:53:43'),
(13, 7, 4, 162, 'medical_service', 70, 5000, 'cash', 4, '2023-06-23 05:39:27', '2023-07-03 17:53:43'),
(14, 8, NULL, NULL, 'unselective', 1363, 1200, 'cash', 5, '2023-06-23 05:57:05', '2023-06-26 08:36:52'),
(15, 8, 5, 163, 'medical_service', 71, 5000, 'cash', 5, '2023-06-23 06:08:32', '2023-06-26 08:36:52'),
(16, 8, 6, 164, 'medical_service', 72, 5000, 'insurance', 4, '2023-06-26 08:59:28', '2023-07-03 17:53:36'),
(17, 8, 6, 165, 'lab', 32, 6000, 'insurance', 4, '2023-06-26 09:09:35', '2023-07-03 17:53:36'),
(18, 8, 6, 166, 'radiography', 20, 2000, 'insurance', 4, '2023-06-26 09:09:35', '2023-07-03 17:53:36'),
(19, 9, NULL, NULL, 'unselective', 1363, 1200, 'cash', 4, '2023-06-28 07:15:28', '2023-07-01 12:00:08'),
(20, 9, 7, 167, 'medical_service', 73, 5000, 'cash', 4, '2023-06-28 07:18:28', '2023-07-01 12:00:14'),
(21, 9, 7, 168, 'lab', 33, 10000, 'cash', 4, '2023-06-28 07:21:10', '2023-07-01 12:00:19'),
(22, 9, 7, 169, 'radiography', 21, 0, 'cash', 4, '2023-06-28 07:21:10', '2023-07-01 12:00:31'),
(23, 9, 8, 173, 'medical_service', 74, 5000, 'cash', 4, '2023-07-01 10:17:03', '2023-07-01 13:58:32'),
(24, 9, 8, 174, 'medical_service', 75, 5000, 'cash', 4, '2023-07-01 13:49:20', '2023-07-01 13:58:32'),
(25, 9, 9, 175, 'medical_service', 76, 5000, 'cash', 4, '2023-07-02 13:35:04', '2023-07-02 18:46:30'),
(26, 9, 9, 176, 'radiography', 22, 0, 'cash', 4, '2023-07-02 13:50:07', '2023-07-02 18:46:30'),
(27, 9, 10, 178, 'medical_service', 77, 5000, 'cash', 2, '2023-07-02 18:46:47', '2023-07-02 18:47:24'),
(28, 9, 10, 179, 'radiography', 23, 0, 'cash', 2, '2023-07-02 18:49:20', '2023-07-02 18:50:22'),
(29, 6, 3, 181, 'lab', 34, 17000, 'cash', 5, '2023-07-03 17:38:56', '2023-07-03 17:51:27'),
(30, 6, 3, 182, 'radiography', 24, 0, 'cash', 5, '2023-07-03 17:38:56', '2023-07-03 17:51:27'),
(31, 8, 11, 183, 'medical_service', 78, 1000, 'cash', 4, '2023-07-03 18:15:50', '2023-07-06 17:51:41'),
(32, 7, 12, 184, 'medical_service', 79, 5000, 'insurance', 4, '2023-07-03 19:05:40', '2023-07-06 17:51:21'),
(33, 7, 12, 185, 'lab', 35, 7000, 'insurance', 5, '2023-07-05 15:33:04', '2023-07-05 15:58:33'),
(34, 7, 12, 187, 'lab', 36, 7000, 'insurance', 5, '2023-07-05 15:50:57', '2023-07-05 15:58:33'),
(35, 7, 12, 188, 'radiography', 25, 50000, 'insurance', 5, '2023-07-05 15:50:57', '2023-07-05 15:58:33'),
(36, 7, 12, 189, 'lab', 37, 7000, 'insurance', 5, '2023-07-05 15:56:20', '2023-07-05 15:58:33'),
(37, 7, 12, 190, 'radiography', 26, 50000, 'insurance', 5, '2023-07-05 15:56:20', '2023-07-05 15:58:33'),
(38, 7, 13, 191, 'medical_service', 80, 5000, 'insurance', 4, '2023-07-05 15:59:28', '2023-07-06 17:51:21'),
(39, 7, 13, 192, 'lab', 38, 17000, 'insurance', 4, '2023-07-05 16:01:41', '2023-07-06 17:51:21'),
(40, 7, 13, 193, 'radiography', 27, 50000, 'insurance', 4, '2023-07-05 16:01:41', '2023-07-06 17:51:21'),
(41, 7, 13, 194, 'lab', 39, 17000, 'insurance', 4, '2023-07-05 16:08:57', '2023-07-06 17:51:21'),
(42, 7, 13, 195, 'radiography', 28, 50000, 'insurance', 4, '2023-07-05 16:08:57', '2023-07-06 17:51:21'),
(43, 6, 14, 198, 'medical_service', 81, 8000, 'cash', 2, '2023-07-06 17:53:40', '2023-07-06 17:54:56'),
(44, 6, 14, 198, 'admission', 1, 50000, 'cash', 1, '2023-07-08 21:02:38', '2023-07-08 21:02:38'),
(45, 9, 10, 178, 'admission', 3, 120000, 'cash', 2, '2023-07-19 17:21:11', '2023-07-19 19:44:06'),
(46, 9, 10, 200, 'medical_service', 82, 1000, 'cash', 2, '2023-07-19 18:32:31', '2023-07-19 20:01:21'),
(47, 9, 10, 203, 'medical_service', 83, 450000, 'cash', 2, '2023-07-21 09:37:10', '2023-07-21 12:23:51'),
(48, 9, 10, 204, 'medical_service', 84, 450000, 'cash', 2, '2023-07-21 12:19:20', '2023-07-21 12:23:52'),
(49, 9, 10, 205, 'radiography', 29, 0, 'cash', 2, '2023-07-22 13:53:35', '2023-07-22 13:54:14'),
(50, 9, 10, 208, 'radiography', 30, 0, 'cash', 2, '2023-07-24 21:49:34', '2023-07-24 21:54:23'),
(51, 9, 10, 209, 'radiography', 31, 0, 'cash', 2, '2023-07-24 21:53:03', '2023-07-24 21:54:23'),
(52, 7, 15, 211, 'medical_service', 85, 5000, 'insurance', 4, '2023-07-25 17:12:07', '2023-07-30 16:08:29'),
(53, 7, 15, 212, 'pharmacy', 1, 150900, 'insurance', 4, '2023-07-25 17:32:31', '2023-07-30 16:08:29'),
(54, 8, 16, 213, 'medical_service', 86, 7000, 'insurance', 2, '2023-07-31 17:08:00', '2023-08-12 13:29:53'),
(55, 10, NULL, NULL, 'unselective', 1363, 1500, 'credit', 1, '2023-08-09 22:21:35', '2023-08-09 22:21:35'),
(56, 2, 17, 214, 'medical_service', 87, 10500, 'insurance', 2, '2023-08-10 14:37:32', '2023-08-12 12:44:36'),
(57, 8, 18, 215, 'medical_service', 88, 2000, 'cash', 2, '2023-08-12 13:25:18', '2023-08-12 13:29:53');
...
INSERT INTO `bill_payments` (`bill_payment_id`, `bill_id`, `amount`, `paid`, `payment_method`, `created_at`, `updated_at`) VALUES
(1, 30, 0, NULL, 'cash', '2023-05-15 13:11:17', '2023-05-15 13:11:17'),
(2, 1, 2000, NULL, 'insurance', '2023-05-15 13:49:17', '2023-05-15 13:49:17'),
(3, 2, 4000, NULL, 'insurance', '2023-06-06 10:27:32', '2023-06-06 10:27:32'),
(4, 3, 2000, NULL, 'insurance', '2023-06-16 15:36:19', '2023-06-16 15:36:19'),
(5, 4, 5000, NULL, 'insurance', '2023-06-16 16:00:37', '2023-06-16 16:00:37'),
(6, 6, 1200, NULL, 'cash', '2023-06-22 18:22:53', '2023-06-22 18:22:53'),
(7, 9, 1200, NULL, 'cash', '2023-06-22 18:30:51', '2023-06-22 18:30:51'),
(8, 10, 6000, NULL, 'cash', '2023-06-22 18:30:51', '2023-06-22 18:30:51'),
(9, 6, 0, NULL, 'cash', '2023-06-22 18:37:35', '2023-06-22 18:37:35'),
(10, 7, 1200, NULL, 'cash', '2023-06-23 05:36:18', '2023-06-23 05:36:18'),
(11, 8, 1200, NULL, 'cash', '2023-06-23 05:57:31', '2023-06-23 05:57:31'),
(12, 12, 1200, NULL, 'cash', '2023-06-23 06:11:32', '2023-06-23 06:11:32'),
(13, 13, 5000, NULL, 'cash', '2023-06-23 06:11:32', '2023-06-23 06:11:32'),
(14, 16, 5000, NULL, 'insurance', '2023-06-26 09:01:57', '2023-06-26 09:01:57'),
(15, 17, 6000, NULL, 'insurance', '2023-06-26 09:17:30', '2023-06-26 09:17:30'),
(16, 18, 2000, NULL, 'insurance', '2023-06-26 09:17:30', '2023-06-26 09:17:30'),
(17, 19, 1200, NULL, 'cash', '2023-06-28 07:16:06', '2023-06-28 07:16:06'),
(18, 20, 5000, NULL, 'cash', '2023-06-28 07:18:55', '2023-06-28 07:18:55'),
(19, 21, 10000, NULL, 'cash', '2023-06-28 07:21:51', '2023-06-28 07:21:51'),
(20, 22, 0, NULL, 'cash', '2023-06-28 07:21:51', '2023-06-28 07:21:51'),
(21, 23, 5000, NULL, 'cash', '2023-07-01 10:28:00', '2023-07-01 10:28:00'),
(22, 24, 5000, NULL, 'cash', '2023-07-01 13:51:30', '2023-07-01 13:51:30'),
(23, 25, 5000, NULL, 'cash', '2023-07-02 13:35:34', '2023-07-02 13:35:34'),
(24, 26, 0, NULL, 'cash', '2023-07-02 13:50:40', '2023-07-02 13:50:40'),
(25, 27, 5000, NULL, 'cash', '2023-07-02 18:47:24', '2023-07-02 18:47:24'),
(26, 28, 0, NULL, 'cash', '2023-07-02 18:50:22', '2023-07-02 18:50:22'),
(27, 31, 1000, NULL, 'cash', '2023-07-03 18:22:00', '2023-07-03 18:22:00'),
(28, 32, 5000, NULL, 'insurance', '2023-07-03 19:06:36', '2023-07-03 19:06:36'),
(29, 38, 5000, NULL, 'insurance', '2023-07-05 16:00:00', '2023-07-05 16:00:00'),
(30, 39, 17000, NULL, 'insurance', '2023-07-05 16:11:20', '2023-07-05 16:11:20'),
(31, 40, 50000, NULL, 'insurance', '2023-07-05 16:11:20', '2023-07-05 16:11:20'),
(32, 41, 17000, NULL, 'insurance', '2023-07-05 16:11:20', '2023-07-05 16:11:20'),
(33, 42, 50000, NULL, 'insurance', '2023-07-05 16:11:20', '2023-07-05 16:11:20'),
(34, 43, 8000, NULL, 'cash', '2023-07-06 17:54:56', '2023-07-06 17:54:56'),
(35, 45, 120000, NULL, 'cash', '2023-07-19 19:44:06', '2023-07-19 19:44:06'),
(36, 46, 1000, NULL, 'cash', '2023-07-19 20:01:21', '2023-07-19 20:01:21'),
(37, 47, 450000, NULL, 'cash', '2023-07-21 12:23:51', '2023-07-21 12:23:51'),
(38, 48, 450000, NULL, 'cash', '2023-07-21 12:23:52', '2023-07-21 12:23:52'),
(39, 49, 0, NULL, 'cash', '2023-07-22 13:54:14', '2023-07-22 13:54:14'),
(40, 50, 0, NULL, 'cash', '2023-07-24 21:54:23', '2023-07-24 21:54:23'),
(41, 51, 0, NULL, 'cash', '2023-07-24 21:54:23', '2023-07-24 21:54:23'),
(42, 52, 5000, NULL, 'insurance', '2023-07-25 17:13:16', '2023-07-25 17:13:16'),
(43, 53, 150900, NULL, 'insurance', '2023-07-25 17:36:45', '2023-07-25 17:36:45'),
(44, 54, 2000, NULL, 'insurance', '2023-07-31 20:48:47', '2023-07-31 20:48:47'),
(47, 56, 7000, NULL, 'insurance', '2023-08-12 12:36:58', '2023-08-12 12:36:58'),
(48, 56, 3500, NULL, 'insurance', '2023-08-12 12:44:36', '2023-08-12 12:44:36'),
(49, 54, 7000, NULL, 'insurance', '2023-08-12 13:29:53', '2023-08-12 13:29:53'),
(50, 57, 2000, NULL, 'cash', '2023-08-12 13:29:53', '2023-08-12 13:29:53');
...
(1, 3, 1689973200, NULL, NULL, NULL, 'patient shows signs of improving and is getting better', 166, 1690033570, 1);
...
(607, '9', 'kahunde', 173, 1690318800, 1);
...
INSERT INTO `doctorreports` (`doctorreport_id`, `drug`, `dosage`, `prescription`, `patientsque_id`, `details`, `labmeasure`, `radiomeasure`, `complaint`, `physical_exam`, `systematic_exam`, `provisional_diagnosis`, `final_diagnosis`, `status`) VALUES
(106, '', NULL, '', 154, '<p>measure</p>\r\n', '4', '', '<p>stomachache</p>\r\n', '<p>heating&nbsp;</p>\r\n', '<p>heatings</p>\r\n', '1,2,3', '1,2,3', 1),
(107, '', NULL, '', 154, '<p>measure</p>\r\n', '5', '', '<p>stomachache</p>\r\n', '<p>heating&nbsp;</p>\r\n', '<p>heatings</p>\r\n', '1,2,3', '1,2,3', 1),
(108, '', NULL, '', 154, '<p>measure</p>\r\n', '7', '', '<p>stomachache</p>\r\n', '<p>heating&nbsp;</p>\r\n', '<p>heatings</p>\r\n', '1,2,3', '1,2,3', 1),
(109, '', NULL, '', 154, '<p>take</p>\r\n', '', '1', '<p>stomachache</p>\r\n', '<p>heating&nbsp;</p>\r\n', '<p>heatings</p>\r\n', '1,2,3', '1,2,3', 1),
(110, '', NULL, '', 154, '<p>take</p>\r\n', '', '2', '<p>stomachache</p>\r\n', '<p>heating&nbsp;</p>\r\n', '<p>heatings</p>\r\n', '1,2,3', '1,2,3', 1),
(111, '', NULL, '', 159, '<p>very sick</p>\r\n', '', '2', '<p>mdmsdm am dm</p>\r\n', '<p>e wme we</p>\r\n', '<p>k smf w</p>\r\n', '3,5', '3,5', 1),
(112, '', NULL, '', 159, '<p>very sick</p>\r\n', '', '3', '<p>mdmsdm am dm</p>\r\n', '<p>e wme we</p>\r\n', '<p>k smf w</p>\r\n', '3,5', '3,5', 1),
(113, '', NULL, '', 164, '<p>measure</p>\r\n', '6', '', '<p>stomach ache</p>\r\n', '<p>backborne pain</p>\r\n', '<p>heating</p>\r\n', '1', '2', 1),
(114, '', NULL, '', 164, '<p>measure</p>\r\n', '12', '', '<p>stomach ache</p>\r\n', '<p>backborne pain</p>\r\n', '<p>heating</p>\r\n', '1', '2', 1),
(115, '', NULL, '', 164, '<p>take the PV screens</p>\r\n', '', '2', '<p>stomach ache</p>\r\n', '<p>backborne pain</p>\r\n', '<p>heating</p>\r\n', '1', '2', 1),
(116, '', NULL, '', 167, '<p>Very sick</p>\r\n', '5', '', '<p>Very sick&nbsp;</p>\r\n', '<p>very sick&nbsp;</p>\r\n', '<p>Very sick&nbsp;</p>\r\n', '2', '4', 1),
(117, '', NULL, '', 167, '<p>Very sick</p>\r\n', '6', '', '<p>Very sick&nbsp;</p>\r\n', '<p>very sick&nbsp;</p>\r\n', '<p>Very sick&nbsp;</p>\r\n', '2', '4', 1),
(118, '', NULL, '', 167, '<p>Very sick</p>\r\n', '7', '', '<p>Very sick&nbsp;</p>\r\n', '<p>very sick&nbsp;</p>\r\n', '<p>Very sick&nbsp;</p>\r\n', '2', '4', 1),
(119, '', NULL, '', 167, '<p>sent pv screens&nbsp;</p>\r\n', '', '1', '<p>Very sick&nbsp;</p>\r\n', '<p>very sick&nbsp;</p>\r\n', '<p>Very sick&nbsp;</p>\r\n', '2', '4', 1),
(120, '', NULL, '', 167, '<p>sent pv screens&nbsp;</p>\r\n', '', '2', '<p>Very sick&nbsp;</p>\r\n', '<p>very sick&nbsp;</p>\r\n', '<p>Very sick&nbsp;</p>\r\n', '2', '4', 1),
(121, '', NULL, '', 173, '<p>Prepare for surgery&nbsp;</p>\r\n', '', '', '', '', '', '', '', 1),
(122, '', NULL, '', 175, '<p>Very Sick&nbsp;</p>\r\n', '', '1', '<p>Very Sick</p>\r\n', '<p>Very Sick&nbsp;</p>\r\n', '<p>Very Sick</p>\r\n', '1,2,3', '4,5,7', 1),
(123, '', NULL, '', 175, '<p>Very Sick&nbsp;</p>\r\n', '', '2', '<p>Very Sick</p>\r\n', '<p>Very Sick&nbsp;</p>\r\n', '<p>Very Sick</p>\r\n', '1,2,3', '4,5,7', 1),
(124, '', NULL, '', 175, '<p>Very Sick&nbsp;</p>\r\n', '', '4', '<p>Very Sick</p>\r\n', '<p>Very Sick&nbsp;</p>\r\n', '<p>Very Sick</p>\r\n', '1,2,3', '4,5,7', 1),
(125, '', NULL, '', 178, '<p>Very Sick</p>\r\n', '', '1', '<p>Very Sick</p>\r\n', '<p>Very SIck</p>\r\n', '<p>Very Sick</p>\r\n', '1,3', '2,3', 1),
(126, '', NULL, '', 178, '<p>Very Sick</p>\r\n', '', '2', '<p>Very Sick</p>\r\n', '<p>Very SIck</p>\r\n', '<p>Very Sick</p>\r\n', '1,3', '2,3', 1),
(127, '', NULL, '', 161, '<p>Very Sick Patient</p>\r\n', '6', '', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,2', '1,3', 1),
(128, '', NULL, '', 161, '<p>Very Sick Patient</p>\r\n', '7', '', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,2', '1,3', 1),
(129, '', NULL, '', 161, '<p>Very Sick Patient</p>\r\n', '8', '', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,2', '1,3', 1),
(130, '', NULL, '', 161, '<p>Very Sick Patient</p>\r\n', '', '1', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,2', '1,3', 1),
(131, '', NULL, '', 161, '<p>Very Sick Patient</p>\r\n', '', '2', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,2', '1,3', 1),
(132, '', NULL, '', 184, '<p>Very sick</p>\r\n', '6', '', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,4', '1,3', 1),
(133, '', NULL, '', 184, '<p>Very sick</p>\r\n', '7', '', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,4', '1,3', 1),
(134, '', NULL, '', 184, '<p>Very sick</p>\r\n', '6', '', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,4', '1,3', 1),
(135, '', NULL, '', 184, '<p>Very sick</p>\r\n', '7', '', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,4', '1,3', 1),
(136, '', NULL, '', 184, '<p>Very Sick</p>\r\n', '', '1', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,4', '1,3', 1),
(137, '', NULL, '', 184, '<p>Very Sick</p>\r\n', '', '2', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,4', '1,3', 1),
(138, '', NULL, '', 184, '<p>Very sick</p>\r\n', '6', '', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,4', '1,3', 1),
(139, '', NULL, '', 184, '<p>Very sick</p>\r\n', '7', '', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,4', '1,3', 1),
(140, '', NULL, '', 184, '<p>Very Sick</p>\r\n', '', '1', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,4', '1,3', 1),
(141, '', NULL, '', 184, '<p>Very Sick</p>\r\n', '', '2', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,4', '1,3', 1),
(142, '', NULL, '', 191, '<p>Very Sick Patient</p>\r\n', '6', '', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,3', '4', 1),
(143, '', NULL, '', 191, '<p>Very Sick Patient</p>\r\n', '7', '', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,3', '4', 1),
(144, '', NULL, '', 191, '<p>Very Sick Patient</p>\r\n', '16', '', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,3', '4', 1),
(145, '', NULL, '', 191, '<p>Very Sick Patient&nbsp;</p>\r\n', '', '1', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,3', '4', 1),
(146, '', NULL, '', 191, '<p>Very Sick Patient&nbsp;</p>\r\n', '', '2', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,3', '4', 1),
(147, '', NULL, '', 191, '<p>Very Sick Patient</p>\r\n', '6', '', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,3', '4', 1),
(148, '', NULL, '', 191, '<p>Very Sick Patient</p>\r\n', '7', '', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,3', '4', 1),
(149, '', NULL, '', 191, '<p>Very Sick Patient</p>\r\n', '16', '', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,3', '4', 1),
(150, '', NULL, '', 191, '<p>Very Sick Patient&nbsp;</p>\r\n', '', '1', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,3', '4', 1),
(151, '', NULL, '', 191, '<p>Very Sick Patient&nbsp;</p>\r\n', '', '2', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '<p>Very Sick Patient</p>\r\n', '1,3', '4', 1),
(152, '', NULL, '', 178, '<p>need the following vitals</p>', '', '', '<p>Very Sick</p>\r\n', '<p>Very SIck</p>\r\n', '<p>Very Sick</p>\r\n', '1,3', '2,3', 1),
(153, '', NULL, '', 178, '<p>need the following vitals</p>\r\n', '', '', '<p>Very Sick</p>\r\n', '<p>Very SIck</p>\r\n', '<p>Very Sick</p>\r\n', '1,3', '2,3', 1),
(154, '', NULL, '', 178, '<p>doing this procedure</p>\r\n', '', '', '<p>Very Sick</p>\r\n', '<p>Very SIck</p>\r\n', '<p>Very Sick</p>\r\n', '1,3', '2,3', 1),
(155, '', NULL, '', 178, '', '', '3', '<p>Very Sick</p>\r\n', '<p>Very SIck</p>\r\n', '<p>Very Sick</p>\r\n', '1,3', '2,3', 1),
(156, '36', NULL, '1*3', 178, '<p>for 2 months</p>\r\n', '', '', '<p>Very Sick</p>\r\n', '<p>Very SIck</p>\r\n', '<p>Very Sick</p>\r\n', '1,3', '2,3', 1),
(157, '', NULL, '', 178, '<p>New details found</p>\r\n', '', '3', '<p>Very Sick</p>\r\n', '<p>Very SIck</p>\r\n', '<p>Very Sick</p>\r\n', '1,3', '2,3', 1),
(158, '', NULL, '', 178, '<p>New details found</p>\r\n', '', '3', '<p>Very Sick</p>\r\n', '<p>Very SIck</p>\r\n', '<p>Very Sick</p>\r\n', '1,3', '2,3', 1),
(159, '', NULL, '', 178, '', '', '', '<p>Very Sick</p>\r\n', '<p>Very SIck</p>\r\n', '<p>Very Sick</p>\r\n', '1,3', '2,3', 1),
(160, '38', 23, '1*3', 211, '<p>Very sick patient</p>\r\n', '', '', '<p>very sick patient</p>\r\n', '<p>very sick patient</p>\r\n', '<p>very sick patient</p>\r\n', '5', '4', 1),
(161, '43', 12, '1*3', 211, '<p>Very sick patient</p>\r\n', '', '', '<p>very sick patient</p>\r\n', '<p>very sick patient</p>\r\n', '<p>very sick patient</p>\r\n', '5', '4', 1);
...
(35, 'Amoxicillin capsule', 'Medicine', 8, 1000, 100, NULL, '250 mg', 0, 1654203600, 1),
(36, 'Amoxicillin DT', 'Medicine', 3, 1000, 200, NULL, '250 mg', 0, 1654203600, 1),
(37, 'Phenoxymthylpenicillin', 'Medicine', 3, 1000, 100, NULL, '250 mg', 0, 1654203600, 1),
(38, 'Flucloxacillin', 'Medicine', 3, 477, 300, NULL, '250 mg', 0, 1654203600, 1),
...
(43, 'Flucamox syrup', 'Medicine', 6, -8, 12000, NULL, '250 mg/5 ml', 0, 1654203600, 1),
...
(110, 'Paracetamol', 'Medicine', 3, 40000, 100, NULL, '500 mg', 41, 1654290000, 1),
(111, 'Paracetamol syrup', 'Medicine', 6, 100, 2000, NULL, '120 mg/5 mil', 41, 1654290000, 1),
...
(233, 'Catheter', 'Medical', 12, 3, 2000, 3000, '', 0, 1690837200, 1),
(234, 'Thermometer', 'Medical', 12, 3, 20000, 23000, '', 0, 1690837200, 1);
...
INSERT INTO `investigationtypes` (`investigationtype_id`, `investigationtype`, `classification_id`, `unitprice`, `creditprice`, `unit_id`, `status`) VALUES
(2, 'Blood group', 3, '3000', NULL, '8', 0),
(3, 'Blood group', 3, '3000', NULL, '8', 0),
(4, 'Cross matching', 3, '3000', NULL, '9', 1),
(5, 'Erythrocytes sedimentation rate (ESR)', 3, '3000', NULL, '10', 1),
(6, 'Hemoglobin(HB) estimation', 3, '4000', NULL, '2', 1),
(7, 'Urine Pregnancy test (UPT)', 7, '3000', NULL, '8', 1),
(8, 'Prothrombine time(PT)', 3, '10000', NULL, '11', 1),
(9, 'Bleeding Time (BT)', 3, '10000', NULL, '11', 0),
(10, 'Clotting time', 3, '10000', NULL, '11', 0),
(11, 'APTT', 3, '10000', NULL, '11', 1),
(12, 'Blood Smear(BS)', 2, '2000', NULL, '12', 1),
(13, 'Malaria Rapid Diagnostic (MRDT)', 2, '2000', NULL, '8', 1),
(14, 'Stool Analysis', 2, '2000', NULL, '9', 1),
(15, 'Urine-Microscope', 2, '2000', NULL, '13', 1),
(16, 'Uric Acid', 7, '10000', NULL, '3', 1),
(17, 'LDL', 7, '10000', NULL, '3', 1),
(18, 'HDL', 7, '10000', NULL, '3', 1),
(19, 'Triglycerides', 7, '10000', NULL, '3', 1),
(20, 'Sodium', 7, '10000', NULL, '14', 1),
(21, 'Potassium', 7, '10000', NULL, '14', 1),
(22, 'Calcium', 7, '10000', NULL, '14', 1),
(23, 'Alkaline Phosphate', 7, '10000', NULL, '3', 1),
(24, 'PTH', 7, '15000', NULL, '9', 1),
(25, 'TSH', 7, '15000', NULL, '9', 1),
(26, 'FT3', 7, '15000', NULL, '9', 1),
(27, 'FT4', 7, '15000', NULL, '9', 1),
(28, 'PSA', 7, '15000', NULL, '9', 1),
(29, 'C.R.P', 7, '15000', NULL, '9', 1),
(30, 'Urea', 7, '10000', NULL, '3', 1),
(31, 'Creatimine', 7, '10000', NULL, '3', 1),
(32, 'S.G.P.T (ASAT)', 7, '30000', NULL, '3', 1),
(33, 'Urine Pregnancy test (UPT)', 7, '30000', NULL, '8', 0),
(34, 'S.G.O.T (ASAT)', 7, '30000', NULL, '3', 1),
(35, 'Cholestrol', 7, '10000', NULL, '3', 1),
(36, 'Rheumatoid factor', 6, '10000', NULL, '8', 1),
(37, 'H.pylor Antigen test', 6, '7000', NULL, '8', 1),
(38, 'H.pylor Antibody test', 6, '7000', NULL, '8', 1),
(39, 'Rapid Plasma Regain (RPR)', 6, '4000', NULL, '15', 1),
(40, 'Hepatitis B', 6, '10000', NULL, '15', 1),
(41, 'Hepatitis C', 6, '10000', NULL, '15', 1),
(42, 'HIV', 6, '0', NULL, '8', 1),
(43, 'AFB', 6, '0', NULL, '9', 1),
(44, 'COVD 19 antigen test', 6, '0', NULL, '8', 1),
(45, 'TPHA', 6, '10000', NULL, '8', 1),
(46, 'GRAM STAIN', 6, '10000', NULL, '9', 1),
(47, 'Urine for Culture and Sensitivity', 6, '15000', NULL, '9', 1),
(48, 'Stool for Culture and Sensitivity', 6, '15000', NULL, '9', 1),
(49, 'Blood for Culture and Sensitivity', 6, '15000', NULL, '9', 0),
(50, 'HVS', 6, '15000', NULL, '9', 1),
(51, 'Liver function test', 7, '30000', NULL, '', 1),
(52, 'Liver function test', 7, '30000', NULL, '', 1),
(53, 'MRDT', 2, '', '2000', '8', 0),
(54, 'MRDT', 2, '0', '2000', '8', 0),
(55, 'Bloos Slide for malaria', 2, '0', '2000', '13', 0),
(56, 'Brucella', 2, '0', '10000', '8', 0),
(57, 'Blood Grouping & X-match', 3, '10000', '', '8', 0),
(58, 'Blood Grouping & X-match', 3, '10000', '', '8', 1);
...
INSERT INTO `issueddrugs` (`issueddrug_id`, `drug`, `quantity`, `patientsque_id`, `admin_id`, `status`) VALUES
(1, 46, 10, 33, 198, 1),
(2, 110, 12, 33, 198, 1),
(3, 38, 50, 107, 205, 1),
(4, 38, 23, 212, 168, 1),
...
(51, 'Devices', 'Non Medical items', 0),
(52, 'stationary', 'Non Medical items', 1),
(53, 'Devices', 'Medical items', 1);
...
(33, 168, 165, 1687936870, 0, 'cash', '0', 'reception', 0, 0),
(34, 181, 165, 1688405936, 0, 'cash', '0', 'reception', 0, 0),
(35, 185, 165, 1688571184, 0, 'insurance', '0', 'reception', 0, 0),
(36, 187, 165, 1688572257, 0, 'insurance', '0', 'reception', 0, 0),
(37, 189, 165, 1688572580, 0, 'insurance', '0', 'reception', 0, 0),
(38, 192, 165, 1688572901, 0, 'insurance', '0', 'reception', 0, 0),
(39, 194, 165, 1688573337, 0, 'insurance', '0', 'reception', 0, 0);
...
INSERT INTO `labreports` (`labreport_id`, `test`, `result`, `patientsque_id`, `details`, `status`) VALUES
(26, '5', '23', 168, '<p>Not done very well</p>', 1),
(27, '6', '45', 168, '<p>Not done very well</p>', 1),
(28, '7', '45', 168, '<p>Not done very well</p>', 1),
(29, '6', '45', 194, '<p>Very DOne</p>', 1),
(30, '7', '45', 194, '<p>Very DOne</p>', 1),
(31, '16', '34', 194, '<p>Very DOne</p>', 1);
...
(1, 3, 1689368400, 'Signs of improvement', 'eating salads', '', 166, 1);
...
INSERT INTO `medicalservices` (`medicalservice_id`, `section_id`, `medicalservice`, `charge`, `creditprice`, `status`) VALUES
(1339, 18, 'Examination form', 10000, NULL, 0),
(1338, 29, 'Incision and drainage', 20000, NULL, 0),
(1337, 29, 'IV injection', 1500, NULL, 1),
(1336, 29, 'IM injection', 1500, NULL, 0),
(1335, 24, 'Delivery', 35000, NULL, 0),
(1334, 29, 'Operation', 450000, NULL, 1),
(1333, 30, 'Weighing', 2000, NULL, 0),
(1332, 30, 'Postnatal care', 2000, NULL, 0),
(1331, 30, 'Antenatal mother care', 2000, NULL, 0),
(1330, 30, 'Weighing', 2000, NULL, 0),
(1329, 30, 'Vaccination', 0, NULL, 0),
(1328, 30, 'IUCD removal', 10000, NULL, 0),
(1327, 30, 'IUCD insertion', 10000, NULL, 0),
(1326, 30, 'Implanon removal', 10000, NULL, 0),
(1325, 30, 'Implanon insertion', 10000, NULL, 0),
(1324, 30, 'HB test', 3000, NULL, 0),
(1323, 30, 'Urinarisis', 2000, NULL, 0),
(1322, 30, 'Consultation (New attendance)', 2000, NULL, 0),
(1321, 25, 'Vital scene', 0, NULL, 0),
(1320, 18, 'Consultation (Revisit)', 3000, NULL, 0),
(1319, 18, 'Consultation (New attendance)', 5000, NULL, 0),
(1318, 18, 'Consultation (New attendance)', 5000, NULL, 0),
(1317, 22, 'test 2', 9000, NULL, 0),
(1316, 22, 'test 2', 9000, NULL, 0),
(1315, 22, 'test 2', 9000, NULL, 0),
(1314, 22, 'test 2', 9000, NULL, 0),
(1313, 26, 'test1', 500, NULL, 0),
(1312, 18, 'Consultation (New attendance)', 5000, NULL, 0),
(1340, 29, 'ADRENALINE NASAL PACK', 2000, 2000, 1),
(1341, 29, 'CARTON DRIP', 50000, 50000, 1),
(1342, 29, 'TEST Medical Consultation', 5000, 5000, 1),
(1343, 29, 'TEST Vital Sign Measurements', 1000, 1000, 1),
(1344, 28, 'TEST Urine', 2000, 2500, 0),
(1345, 28, 'TEST Malaria', 2000, 2500, 0),
(1346, 28, 'Brucella', 10000, 10000, 0),
(1347, 28, 'Blood Smear for malaria', 2000, 2000, 0),
(1348, 28, 'MRDT', 2000, 2000, 0),
(1349, 28, 'Uric Acid', 10000, 10000, 0),
(1350, 28, 'H.pylori Stool Ag', 7000, 7000, 0),
(1351, 29, 'stoolanalysis', 2000, 2000, 1),
(1352, 28, 'urinalysis', 2000, 2000, 0),
(1353, 28, 'ESR', 3000, 3000, 0),
(1354, 28, 'FBP', 15000, 15000, 0),
(1355, 28, 'RPR', 4000, 4000, 0),
(1356, 28, 'Hb', 4000, 4000, 0),
(1357, 28, 'RBG', 3000, 3000, 0),
(1358, 28, 'FBG', 3000, 3000, 0),
(1359, 28, 'B.Grouping and xmatch', 10000, 10000, 0),
(1360, 28, 'UPT', 3000, 3000, 0),
(1361, 29, 'consultation', 5000, 5000, 1),
(1362, 29, 'Test Service', 5000, 6000, 1),
(1363, 26, 'Registration Fee', 1200, 1500, 2);
...
INSERT INTO `minor` (`minor_id`, `admission_id`, `service_id`, `casetype`, `details`, `admin_id`, `patientsque_id`, `timestamp`, `status`) VALUES
(1, 1, 1340, 'done  very well', '<p>done well</p>\r\n', 166, 153, 1689976984, 1),
(2, 1, 1351, 'not bad', '<p>completed</p>\r\n', 166, 153, 1689976984, 1);
...
(5, 'BP', '120/50mm', 200, '<p>Very Sick Patient</p>\r\n', 1),
(6, 'Weight', '102', 200, '<p>Very Sick Patient</p>\r\n', 1);
...
(1, 3, '1970-01-01', '03:00:00', '50/90', '23', '34', '34', 'massive stool discharge', '12', '1', '23', '45 ml', '3 ml', '34', '45', '345', 166, 1);
...
INSERT INTO `operations` (`operation_id`, `patient_id`, `date`, `time`, `anareport_id`, `anareport2_id`, `anesthesiologist`, `admin_id`, `timestamp`, `status`) VALUES
(1, 9, '2023-07-23', '12:07:00', 2, 1, 177, 165, 1689945593, 4);
...
(8, 4, 100, 23, 'pharmacy', NULL, NULL, NULL),
(9, 4, 87, 7, 'pharmacy', NULL, NULL, NULL),
(10, 4, 44, 2, 'pharmacy', NULL, NULL, NULL),
(11, 4, 46, 9, 'pharmacy', NULL, NULL, NULL),
(12, 5, 100, 10, 'pharmacy', NULL, NULL, NULL),
(13, 6, 233, 6, 'nurse', NULL, NULL, NULL),
(14, 6, 234, 8, 'nurse', NULL, NULL, NULL),
(15, 7, 44, 5, 'nurse', NULL, NULL, NULL),
(16, 8, 233, 30, 'pharmacy', NULL, NULL, NULL),
(17, 9, 100, 56, 'pharmacy', NULL, NULL, NULL),
(18, 10, 100, 27, 'doctor', NULL, NULL, NULL),
(19, 10, 40, 29, 'doctor', NULL, NULL, NULL);
...
INSERT INTO `patients` (`patient_id`, `firstname`, `secondname`, `thirdname`, `gender`, `dob`, `maritalstatus`, `spousename`, `spousephone`, `spouseaddress`, `religion`, `occupation`, `phone`, `address`, `email`, `employmentstatus`, `employername`, `employeraddress`, `employernumber`, `emergencyname`, `emergencyrelationship`, `emergencyphone`, `emergencyaddress`, `paymenttype`, `creditclient`, `insurancecompany`, `subscribername`, `socialsecuritynumber`, `policyidnumber`, `insuranceemployer`, `insurancedob`, `insurancecardext`, `secondarysubscribername`, `vote`, `contact`, `maximum_coverage`, `subscriptiontype`, `primary_name`, `primary_org`, `primary_relationship`, `patientrelation`, `workphone`, `bloodgroup`, `weight`, `temp`, `bp`, `height`, `allergies`, `diseases`, `pregnancies`, `smoke`, `drink`, `druguse`, `drugtypes`, `exercise`, `specialdiet`, `activities`, `ext`, `docext`, `admin_id`, `timestamp`, `level`, `status`, `primary_contact`) VALUES
(1, 'CATHERINE', 'CHARLES', 'GEORGE', 'Female', '886539600', '', '', '', '', '', 'farmer', '0656800268', 'MACHINJIONI', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', NULL, NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', 190, 1684155412, 4, '0', NULL),
(2, 'MISHERI', 'CHRISTIAN', '', 'Female', '1598216400', '', '', '', '', '', 'CHILD', '0762399259', 'NYAMADOKE', '', 'Full time', 'Munoclub', '', '123456', '', '', '', '', 'credit', '3', '18', '', '', '23456', '', '', '', '', NULL, '07895684583', '2000000', 'primary', '', '', '', '', '', 'O', '80', NULL, NULL, '123', 'Allergic to mazie', 'Null', '', '', '', '', '', '', '', '', '', '', 190, 1684156175, 2, '1', ''),
(3, 'CATHERINR', 'CHARLES', 'GEORGE', 'Female', '894920400', '', '', '', '', '', 'STUDENT', '0656800268', 'MACHINJIONI', '', '', '', '', '', '', '', '', '', 'credit', '4', '', '', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', NULL, NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', 190, 1684156835, 4, '3', NULL),
(4, 'test1', 'patient', '', 'Male', '740782800', '', '', '', '', '', 'accountant', '0700123456', 'Kiseke Sokoni', '', 'Full time', '', '', 'Ufanisi Africa', 'relative test1', 'Cousin', '0600123456', 'Bwiru', 'insurance', '', '23', '', '', '09287636', '', '', '', '', NULL, '', '1000000', 'primary', '', '', '', '', '', 'A-', '46', NULL, NULL, '1.62', 'No', 'No', '', '', '', '', '', '', '', '', '', '', 163, 1684157673, 2, '1', ''),
(5, 'Ufanisi', 'Patient', '', 'Female', '769122000', '', '', '', '', '', 'accountant', '0784000000', 'Ilemela', '', 'Full time', 'Nyakahoja', '', '0732000000', 'Ufanisi Relative', 'Brother', '0753000000', 'Kisesa', 'credit', '4', '19', '', '', '09386483753', '', '', '', '', NULL, '', '', 'primary', '', '', '', '', '', '', '', NULL, NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', 163, 1686999837, 4, '3', ''),
(6, 'Kahunde', 'ELIz', '', 'Female', '', '', '', '', '', '', 'DOctor', '256893938929', 'Entebbe', '', '', '', '', '', 'James', 'Brother', '25678948583', 'Nakawa', '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', 'O', '78', NULL, NULL, '233', '', '', '', '', '', '', '', '', '', '', '', '', 163, 1687458040, 2, '1', NULL),
(7, 'Test2', 'Patient', '', 'Male', '736549200', '', '', '', '', '', 'Driver', '0784083864', 'Ghana', '', '', '', '', '', 'relative2 patient', 'brother', '0783874753', 'Kisesa', 'insurance', '', '18', '', '', '094874656538', '', '', '', '', NULL, '', '', 'primary', '', 'Lake Oil', 'procurement officer', '', '', 'B-', '54', NULL, NULL, '1.52', 'NO', 'NO', '', '', '', '', '', '', '', '', '', '', 163, 1687498488, 2, '1', '0788386584'),
(8, 'test3', 'patient', '', 'Female', '438469200', '', '', '', '', '', 'nurse', '0745238745', 'Isamilo', '', '', '', '', '', 'Jesca Magambo', 'sister', '0785983865', 'Nyegezi', 'insurance', '', '24', '', '', '094874654', '', '', '', '', NULL, '', '', 'primary', '', 'ABM Africultural Agency', 'Cashier', '', '', 'A-', '65', NULL, NULL, '1.48', 'Meat', 'no', '2', '', '', '', '', '', '', '', '', '', 163, 1687499715, 2, '1', '0784764635'),
(9, 'Kahy', 'James', '', 'Male', '', '', '', '', '', '', 'Accountant', '0788949499393', 'Entebbe', '', '', '', '', '', 'James', 'Brother', '25678948583', 'Nakawa', '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', 'O', '89', '34', '120/59', '190', 'None', 'None', '0', '', '', '', '', '', '', '', '', '', 163, 1687936499, 2, '1', NULL),
(10, 'Kahuma', 'James', '', 'Male', '965854800', '', '', '', '', '', 'Accountant', '0788949499393', 'Entebbe', '', '', '', '', '', 'James', 'Brother', '25678948583', 'Nakawa', 'credit', '2', '', '', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', NULL, NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', 163, 1691619286, 4, '3', NULL);
...
(117, 81, 1343, 1000, 1),
(118, 82, 1343, 1000, 1),
(119, 83, 1334, 450000, 1),
(120, 84, 1334, 450000, 1),
(121, 85, 1361, 5000, 1),
(122, 86, 1340, 2000, 1),
(123, 86, 1361, 5000, 1),
(124, 87, 1340, 2000, 2),
...
(153, 1, 'nurse', 166, 1, 'insurance', 163, 'receptionist', NULL, 1686047230, 1),
...
(161, 3, 'doctor', 176, 1, 'cash', 176, 'radiographer', 160, 1687459911, 1),
...
(165, 6, 'lab', 167, 1, 'insurance', 165, 'doctor', 164, 1687770575, 0),
(166, 6, 'radiography', 176, 1, 'insurance', 165, 'doctor', 164, 1687770575, 1),
(167, 7, 'doctor', 0, 1, 'cash', 163, 'receptionist', NULL, 1687936708, 1),
(168, 7, 'lab', 0, 1, 'cash', 165, 'doctor', 167, 1687936870, 1),
(169, 7, 'radiography', 0, 1, 'cash', 165, 'doctor', 167, 1687936870, 1),
(170, 7, 'doctor', 165, 1, 'cash', 167, 'lab technician', 168, 1687937147, 1),
(171, 7, 'doctor', 165, 1, 'cash', 176, 'radiographer', 169, 1687937796, 1),
(172, 6, 'doctor', 0, 1, 'cash', 176, 'radiographer', 166, 1687941667, 0),
(173, 8, 'doctor', 0, 1, 'cash', 163, 'receptionist', NULL, 1688206623, 1),
(174, 8, 'anesthesiology', 0, 1, 'cash', 165, 'doctor', 173, 1688219360, 0),
(175, 9, 'doctor', 0, 1, 'cash', 163, 'receptionist', NULL, 1688304904, 1),
(176, 9, 'radiography', 0, 1, 'cash', 165, 'doctor', 175, 1688305807, 1),
(177, 9, 'doctor', 0, 1, 'cash', 176, 'radiographer', 176, 1688323172, 0),
(178, 10, 'doctor', 0, 1, 'cash', 163, 'receptionist', NULL, 1688323607, 1),
(179, 10, 'radiography', 0, 1, 'cash', 165, 'doctor', 178, 1688323760, 1),
(180, 10, 'doctor', 165, 1, 'cash', 176, 'radiographer', 179, 1688323998, 1),
(181, 3, 'lab', 0, 0, 'cash', 165, 'doctor', 161, 1688405936, 0),
(182, 3, 'radiography', 0, 0, 'cash', 165, 'doctor', 161, 1688405936, 0),
(183, 11, 'nurse', 0, 1, 'cash', 163, 'receptionist', NULL, 1688408150, 0),
(184, 12, 'doctor', 0, 1, 'insurance', 163, 'receptionist', NULL, 1688411140, 1),
(185, 12, 'lab', 0, 0, 'cash', 165, 'doctor', 184, 1688571184, 0),
(186, 12, 'radiography', 0, 0, 'cash', 165, 'doctor', 184, 1688571184, 0),
(187, 12, 'lab', 0, 0, 'cash', 165, 'doctor', 184, 1688572257, 0),
(188, 12, 'radiography', 0, 0, 'cash', 165, 'doctor', 184, 1688572257, 0),
(189, 12, 'lab', 0, 0, 'cash', 165, 'doctor', 184, 1688572580, 0),
(190, 12, 'radiography', 0, 0, 'cash', 165, 'doctor', 184, 1688572580, 0),
(191, 13, 'doctor', 0, 1, 'insurance', 163, 'receptionist', NULL, 1688572768, 1),
(192, 13, 'lab', 0, 1, 'insurance', 165, 'doctor', 191, 1688572901, 0),
(193, 13, 'radiography', 0, 1, 'insurance', 165, 'doctor', 191, 1688572901, 0),
(194, 13, 'lab', 0, 1, 'insurance', 165, 'doctor', 191, 1688573337, 1),
(195, 13, 'radiography', 0, 1, 'insurance', 165, 'doctor', 191, 1688573337, 1),
(196, 13, 'doctor', 165, 1, 'cash', 167, 'lab technician', 194, 1688573534, 1),
(197, 13, 'doctor', 165, 1, 'cash', 176, 'radiographer', 195, 1688573904, 1),
(198, 14, 'doctor', 0, 1, 'cash', 163, 'receptionist', NULL, 1688666020, 1),
(199, 10, 'admission', 0, 0, 'cash', 165, 'doctor', 178, 1689787271, 0),
(200, 10, 'nurse', 0, 1, 'cash', 165, 'doctor', 178, 1689791551, 1),
(201, 10, 'anesthesiology', 0, 1, 'cash', 165, 'doctor', 178, 1689791551, 1),
(202, 10, 'doctor', 165, 0, 'cash', 166, 'nurse', 200, 1689800570, 1),
(203, 10, 'doctor', 0, 1, 'cash', 165, 'doctor', 0, 1689932230, 0),
(204, 10, 'anesthesiology', 0, 1, 'cash', 165, 'doctor', 178, 1689941959, 1),
(205, 10, 'radiography', 0, 1, 'cash', 165, 'doctor', 178, 1690034015, 1),
(206, 10, 'doctor', 165, 1, 'cash', 176, 'radiographer', 205, 1690034199, 1),
(207, 10, 'pharmacy', 0, 0, 'cash', 165, 'doctor', 178, 1690230595, 0),
(208, 10, 'radiography', 0, 1, 'cash', 165, 'doctor', 178, 1690235374, 0),
(209, 10, 'radiography', 0, 1, 'cash', 165, 'doctor', 178, 1690235583, 0),
(210, 10, 'acts', 0, 0, 'cash', 165, 'doctor', 178, 1690235583, 0),
(211, 15, 'doctor', 0, 1, 'insurance', 163, 'receptionist', NULL, 1690305127, 1),
(212, 15, 'pharmacy', 0, 1, 'insurance', 165, 'doctor', 211, 1690306351, 1),
(213, 16, 'doctor', 0, 1, 'insurance', 163, 'receptionist', NULL, 1690823280, 0),
(214, 17, 'doctor', 0, 1, 'insurance', 163, 'receptionist', NULL, 1691678252, 0),
(215, 18, 'doctor', 0, 1, 'insurance', 163, 'receptionist', NULL, 1691846718, 0);
...
(48, 10, 'credit', 163, '2023-08-10 01:20:03', 1);
...
INSERT INTO `pharmacyordereditems` (`pharmacyordereditem_id`, `item_id`, `pharmacyorder_id`, `prescription`, `quantity`, `status`) VALUES
(1, '38', 1, '1*3', '23', 2),
(2, '43', 1, '1*3', '12', 2);
...
(1, 212, 165, 1690306351, 1, 164, 'insurance', 'doctor', 1);
...
(1, 2, 1691351569, 168, 1),
(2, 2, 1691351744, 168, 4);
...
(1, 'KUB Ultrasound', '2', '0', '20000', 1),
(2, 'OBS ultrasound', '2', '0', '15000', 1),
(3, 'abd-pelvic ultrasound', '2', '0', '20000', 1),
(4, 'obs ultrasond 2nd', '2', '0', '10000', 1);
...
INSERT INTO `radiologyreports` (`radiologyreport_id`, `patientsque_id`, `month`, `year`, `reason`, `description`, `results`, `conclusion`, `responsible`, `exitmode`, `destination`, `admin_id`, `timestamp`, `status`) VALUES
(1, 160, 'June', 2023, '', 'very Sick patient', 'very sick patient', 'very sick', 'Doctor jimmy', 'transfert intra hÃ´pital', '', 176, 1687459911, 1),
(2, 169, 'June', 2023, '', 'Very sick', 'very sick', 'Very sick', 'Doctor', 'transfert intra hôpital', '', 176, 1687937796, 1),
(3, 171, 'June', 2023, 'very sick patient', 'Very sick', 'very sick', 'Very sick', 'Doctor', 'transfert intra hôpital', '', 176, 1687941667, 1),
(4, 176, 'July', 2023, 'Radiology Report', 'The difference between desire ', '', 'Very sick skin', '', '', '', 176, 1688323122, 1),
(5, 176, 'July', 2023, 'Radiology Report', 'The difference between desire ', '', 'Very sick skin', '', '', '', 176, 1688323172, 1),
(6, 176, 'July', 2023, 'Radiology Report', 'the design of the sockss', '', 'Very sick skin', '', '', '', 176, 1688323172, 1),
(7, 176, 'July', 2023, 'Radiology Report', 'the designing for various deployment', '', 'Very sick skin', '', '', '', 176, 1688323172, 1),
(8, 179, 'July', 2023, 'Radiology Report', 'Very Sick Patient', '1', 'Very sick patient', '', '', '', 176, 1688323998, 1),
(9, 179, 'July', 2023, 'Radiology Report', 'Very  Sick patient', '2', 'Very sick patient', '', '', '', 176, 1688323998, 1),
(10, 195, 'July', 2023, 'Radiology Report', 'Very Sick', '1', 'Check the patient', '', '', '', 176, 1688573903, 1),
(11, 195, 'July', 2023, 'Radiology Report', 'Very Sick', '2', 'Check the patient', '', '', '', 176, 1688573904, 1),
(12, 205, 'July', 2023, 'Radiology Report', 'Very sick', '3', 'completed with dangerous images', '', '', '', 176, 1690034199, 1);
...
(21, 169, 165, 1687936870, 0, 'cash', '0', 'reception', 0, 0),
(22, 176, 165, 1688305807, 0, 'cash', '0', 'reception', 0, 0),
(23, 179, 165, 1688323760, 0, 'cash', '0', 'reception', 0, 0),
(24, 182, 165, 1688405936, 0, 'cash', '0', 'reception', 0, 0),
(25, 188, 165, 1688572257, 0, 'insurance', '0', 'reception', 0, 0),
(26, 190, 165, 1688572580, 0, 'insurance', '0', 'reception', 0, 0),
(27, 193, 165, 1688572901, 0, 'insurance', '0', 'reception', 0, 0),
(28, 195, 165, 1688573337, 0, 'insurance', '0', 'reception', 0, 0),
(29, 205, 165, 1690034015, 0, 'cash', '0', 'reception', 0, 0),
(30, 208, 165, 1690235374, 0, 'cash', '0', 'reception', 0, 0),
(31, 209, 165, 1690235583, 0, 'cash', '0', 'reception', 0, 0);
...
(9, 9, 1, 163, '2023-06-28 10:16:32', 0);
...
(1, 1, 195, 'Medicine', 50, 350, 1),
(2, 2, 230, 'Medicine', 50, 450, 1),
(3, 3, 43, 'Medicine', 87, 500, 1),
(4, 4, 144, 'Medicine', 20, 5600, 1),
(5, 6, 45, 'Medicine', 6, 340, 1),
(6, 6, 43, 'Medicine', 23, 500, 4),
(9, 6, 43, 'Medicine', 11, 500, 1),
(10, 7, 45, 'Medicine', 23, 0, 1),
(11, 8, 43, 'Medicine', 8, 0, 1),
(12, 9, 45, 'Medicine', 7, 0, 1),
(13, 9, 43, 'Medicine', 45, 0, 1),
(14, 10, 45, 'Medicine', 8, 340, 1),
(15, 10, 43, 'Medicine', 23, 500, 1),
(16, 11, 35, 'Medicine', 34, 3000, 1),
(17, 11, 233, 'Medical', 23, 4500, 1);
...
(1, 2, 8, NULL, 1691182800, 175, 4),
(2, 2, 8, NULL, 1691182800, 175, 1),
(3, 2, 8, NULL, 1691182800, 175, 0),
(4, 2, 0, NULL, 1691182800, 175, 4),
(5, 2, 8, '0000-00-00', 1691269200, 175, 0),
(6, 2, 8, '2023-08-08', 1691269200, 175, 0),
(7, 0, 0, '0000-00-00', 1691269200, 175, 0),
(8, 0, 0, '0000-00-00', 1691269200, 175, 0),
(9, 0, 0, '0000-00-00', 1691269200, 175, 0),
(10, 2, 8, '2023-08-17', 1691269200, 175, 0),
(11, 2, 0, '0000-00-00', 1691269200, 175, 0);
...
(73, 167, 163, 1687899600, 1, 'cash', '73', 'reception', 164, 1),
(74, 173, 163, 1688158800, 1, 'cash', '74', 'reception', 164, 1),
(75, 174, 165, 1688158800, 1, 'cash', '75', 'reception', 164, 1),
(76, 175, 163, 1688245200, 1, 'cash', '76', 'reception', 164, 1),
(77, 178, 163, 1688245200, 1, 'cash', '77', 'reception', 164, 1),
(78, 183, 163, 1688331600, 1, 'cash', '78', 'reception', 164, 1),
(79, 184, 163, 1688331600, 1, 'insurance', '79', 'reception', 164, 1),
(80, 191, 163, 1688504400, 1, 'insurance', '80', 'reception', 164, 1),
(81, 198, 163, 1688590800, 1, 'cash', '81', 'reception', 164, 1),
(82, 200, 165, 1689714000, 1, 'cash', '82', 'reception', 164, 1),
(83, 203, 165, 1689886800, 1, 'cash', '83', 'doctor', 164, 1),
(84, 204, 165, 1689886800, 1, 'cash', '84', 'doctor', 164, 1),
(85, 211, 163, 1690232400, 1, 'insurance', '85', 'reception', 164, 1),
(86, 213, 163, 1691787600, 1, 'insurance', '86', 'reception', 170, 1),
(87, 214, 163, 1691787600, 1, 'insurance', '87', 'reception', 164, 1),
(88, 215, 163, 1691787600, 1, 'insurance', '88', 'reception', 170, 1);
...
(172, 'Ufanisi Director', '0627129837', 'Male', 'director@elctelvdhospital.info', 'director', 'jpg', 53, 1, 1643662800, 1708635600, 1, 'head physician', 'e10adc3949ba59abbe56e057f20f883e', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1645045200, 1),
...
(176, 'Ufanisi Radiographer', '0789286537', 'Male', 'radiographer@elctelvdhospital.info', 'radiographer', 'png', 14, 2, 1667250000, 1703624400, 4, 'radiographer', 'e10adc3949ba59abbe56e057f20f883e', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1669496400, 1),
(177, 'Ufanisi anethetist', '0714286405', 'Male', 'anesthesiologist@elctelvdhospital.info', '', 'png', 12, 3, 1667336400, 1707771600, 1, 'anesthesiologist', 'e10adc3949ba59abbe56e057f20f883e', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1669496400, 1),
...
(182, 'test admin', '430-909-3375', 'Male', 'test@admin.com', '', '', 28, 1, 1675198800, 1703883600, 1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'Bachelor Degree', 'Doc', '', '', '', '', '', 1676667600, 1),
...
(184, 'Nassuna timothy Jimmy', '0708389485', 'Female', 'test@receptionist.com', '', '', 48, 2, 1676667600, 1708203600, 5, 'receptionist', 'd39f2a8079b4b72d11fb10b5b4c0c2ab', 'Certificate', '', 'James ', 'Brother', '0708389485', 'Kampala', '5', 1676667600, 1),
...
(186, 'Test Doctor', '0748228275', 'Male', 'test@doctor.com', '', '', 2, 2, 1676667600, 1708203600, 1, 'doctor', 'e10adc3949ba59abbe56e057f20f883e', 'Post Graduate', '', '', '', '', '', '', 1676667600, 1),
...
(211, 'Miriam Desire', '0788949499393', 'Female', 'lab2@elctelvdhospital.info', '', 'jpg', 0, 2, 1690491600, 1722027600, 0, 'lab technologist', 'e10adc3949ba59abbe56e057f20f883e', 'Bachelor Degree', '6', 'Kaganzi Timothy', 'Brother', '25678345686', 'Entebbe', '5', 1690318800, 1),
(212, 'Head Teacher', '0788949499393', 'Male', 'timothykaganzi@gmail.com', 'mm', '', 47, 1, 1691442000, 1693602000, 0, '', 'none', 'Certificate', '4', '', '', '', '', '5', 1691442000, 1);
...
(106, 232, 2, 'Medical', 500, '2023-05-31', 202, 1680159233, 1, NULL),
(107, 232, 2, 'Medical', 20, '2023-05-25', 202, 1680159233, 1, NULL),
(108, 133, 2, NULL, 20, '2024-05-29', 175, 1690616789, 1, NULL),
(109, 134, 2, NULL, 34, '2024-07-12', 175, 1690616789, 1, NULL),
(110, 185, 2, NULL, 4, '2024-12-30', 175, 1690616789, 1, NULL),
(111, 234, 2, NULL, 90, '0000-00-00', 175, 1690911783, 1, NULL),
(112, 233, 2, 'Medical', 90, '2025-08-29', 175, 1690911783, 1, NULL),
(113, 233, 2, 'Medical', 40, '0000-00-00', 175, 1690999969, 1, NULL),
(114, 234, 2, 'Medical', 23, '0000-00-00', 175, 1690999969, 1, NULL),
(115, 37, 2, 'Medicine', 45, '2025-08-28', 175, 1691000327, 1, NULL),
(116, 101, 2, 'Medicine', 45, '2023-08-31', 175, 1691000327, 1, NULL),
(117, 44, 2, 'Medicine', 120, '2025-08-27', 175, 1691223878, 1, NULL),
(118, 100, 2, 'Medicine', 200, '2025-08-28', 175, 1691224836, 1, NULL),
(119, 234, 2, 'Medical', 34, '0000-00-00', 168, 1691349412, 1, NULL),
(120, 233, 2, 'Medical', 30, '0000-00-00', 168, 1691349412, 1, NULL),
(121, 233, 2, 'Medical', 9, '0000-00-00', 168, 1691351569, 1, 1),
(122, 234, 2, 'Medical', 9, '0000-00-00', 168, 1691351569, 1, 1),
(123, 233, 2, 'Medical', 8, '0000-00-00', 168, 1691351744, 4, 2),
(124, 234, 2, 'Medical', 45, '0000-00-00', 168, 1691432353, 4, 2);
...
(3, 'pharmacy', '0', NULL, NULL, 205, 1681736897, 1),
(4, 'pharmacy', '0', NULL, NULL, 168, 1690619828, 1),
(5, 'pharmacy', '0', NULL, NULL, 168, 1690620378, 1),
(6, 'nurse', '16', 'Medical', NULL, 166, 1690916364, 4),
(7, 'nurse', '0', 'Medicine', NULL, 166, 1690921952, 0),
(8, 'pharmacy', '0', 'Medical', NULL, 168, 1691218703, 0),
(9, 'pharmacy', '0', 'Medicine', NULL, 168, 1691221120, 0),
(10, 'doctor', '0', 'Medicine', '173', 165, 1691235944, 1);
...
(8, 'James Peterson', 'Entebbe', '0788949499393', 'timothykaganzi@gmail.com', 173, 1690318800, 1),
(9, 'James Peterson gina', 'Entebbe', '0788949499393', 'pascalgituro806@mail.com', 173, 1690318800, 1);
...
--
ALTER TABLE `admitted`
  MODIFY `admitted_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `anaesthesiareport`
  MODIFY `anareport_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `anaesthesiareport2`
--
ALTER TABLE `anaesthesiareport2`
  MODIFY `anareport2_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `anaesthesiareportcns`
--
ALTER TABLE `anaesthesiareportcns`
  MODIFY `anareportcns_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `anaesthesiareporthem`
  MODIFY `anareporthem_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `anaesthesiareportlabs`
--
ALTER TABLE `anaesthesiareportlabs`
  MODIFY `anareportlab_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `anaesthesiareportonc`
  MODIFY `anareportonc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `anaesthesiareportoth`
--
ALTER TABLE `anaesthesiareportoth`
  MODIFY `anareportoth_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `anaesthesiareportpe`
--
ALTER TABLE `anaesthesiareportpe`
  MODIFY `anareportpe_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `anaesthesiareportpla`
--
ALTER TABLE `anaesthesiareportpla`
  MODIFY `anareportpla_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `anaesthesiareportpul`
--
ALTER TABLE `anaesthesiareportpul`
  MODIFY `anareportpul_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `anaesthesiareportrenal`
  MODIFY `anareportrenal_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `anaesthesiareportvitals`
  MODIFY `anareportvit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `bill_payments`
  MODIFY `bill_payment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `clientcredits`
  MODIFY `clientcredit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `creditclients`
  MODIFY `creditclient_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `discharged`
  MODIFY `discharged_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `diseases`
--
ALTER TABLE `diseases`
  MODIFY `disease_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=608;

--
-- AUTO_INCREMENT for table `doctorreports`
--
ALTER TABLE `doctorreports`
  MODIFY `doctorreport_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=162;
...
--
ALTER TABLE `insurancecompanies`
  MODIFY `insurancecompany_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `insuredinventoryitems`
  MODIFY `insuredinventoryitem_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT for table `insuredinvestigationtypes`
--
ALTER TABLE `insuredinvestigationtypes`
  MODIFY `insuredinvestigationtype_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=197;
...
--
ALTER TABLE `insuredservices`
  MODIFY `insuredservice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=138;
...
--
ALTER TABLE `inventoryitems`
  MODIFY `inventoryitem_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=235;

--
-- AUTO_INCREMENT for table `investigationsubtypes`
--
ALTER TABLE `investigationsubtypes`
  MODIFY `investigationsubtype_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `investigationtypes`
--
ALTER TABLE `investigationtypes`
  MODIFY `investigationtype_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT for table `issueddrugs`
--
ALTER TABLE `issueddrugs`
  MODIFY `issueddrug_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `itemcategories`
--
ALTER TABLE `itemcategories`
  MODIFY `itemcategory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
ALTER TABLE `laborders`
  MODIFY `laborder_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT for table `labreports`
--
ALTER TABLE `labreports`
  MODIFY `labreport_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `labunits`
--
ALTER TABLE `labunits`
  MODIFY `measurement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `medicalcase`
--
ALTER TABLE `medicalcase`
  MODIFY `medicalcase_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `medicalservices`
--
ALTER TABLE `medicalservices`
  MODIFY `medicalservice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1364;

--
-- AUTO_INCREMENT for table `minor`
--
ALTER TABLE `minor`
  MODIFY `minor_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `nursereports`
  MODIFY `nursereport_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `nursingsheetmedications`
--
ALTER TABLE `nursingsheetmedications`
  MODIFY `nursingsheetmedication_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `nursingsheets`
--
ALTER TABLE `nursingsheets`
  MODIFY `nursingsheet_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `ordereditems`
  MODIFY `ordereditem_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `patientlabs`
--
ALTER TABLE `patientlabs`
  MODIFY `patientlab_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT for table `patientradios`
--
ALTER TABLE `patientradios`
  MODIFY `patientradio_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `patientservices`
  MODIFY `patientservice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;

--
-- AUTO_INCREMENT for table `patientsque`
--
ALTER TABLE `patientsque`
  MODIFY `patientsque_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=216;
...
--
ALTER TABLE `paymethod`
  MODIFY `paymethod_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `pharmacyordereditems`
  MODIFY `pharmacyordereditem_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `pharmacyorders`
--
ALTER TABLE `pharmacyorders`
  MODIFY `pharmacyorder_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `pharstockorders`
--
ALTER TABLE `pharstockorders`
  MODIFY `pharstockorder_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `radiologyimages`
  MODIFY `radioimage_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `radiologyreports`
--
ALTER TABLE `radiologyreports`
  MODIFY `radiologyreport_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `radioorders`
--
ALTER TABLE `radioorders`
  MODIFY `radioorder_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `referral`
  MODIFY `referr_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `restockitems`
  MODIFY `restockitem_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `restockorders`
--
ALTER TABLE `restockorders`
  MODIFY `restockorder_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `serviceorders`
  MODIFY `serviceorder_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
...
--
ALTER TABLE `staff`
  MODIFY `staff_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=213;
...
--
ALTER TABLE `stockitems`
  MODIFY `stockitem_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;

--
-- AUTO_INCREMENT for table `stockorders`
--
ALTER TABLE `stockorders`
  MODIFY `stockorder_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `supplierproducts`
  MODIFY `supplierproduct_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `surgeryhistory`
  MODIFY `surgeryhistory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `usedcredit`
  MODIFY `usedcredit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
