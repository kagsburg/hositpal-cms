...
$id = $_GET['id'];
$getinvestigation =  mysqli_query($con, "SELECT * FROM radioinvestigationtypes WHERE status=1 AND radioinvestigationtype_id='$id'");
$row1 =  mysqli_fetch_array($getinvestigation);
$investigation_id = $row1['radioinvestigationtype_id'];
            ...
            <div class="row page-titles mx-0">
               ...
               <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                  <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item"><a href="radiographyinvestigationtypes">Radiography Investigation Types</a></li>
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        ...
                        <table id="example5" class="display" class="table table-striped" style="width:100%;">
                           ...
                           <tbody>
                              <?php
                              $getinsured =  mysqli_query($con, "SELECT * FROM insuredradiotypes WHERE status=1 AND investigationtype_id='$id'");
                              while ($row1 =  mysqli_fetch_array($getinsured)) {
                                 $insured_id = $row1['insuredradiotype_id'];
                              ...
                              ?>
                                 <tr>
                                    ...
                                    <td>
                                       ...
                                       <a href="removeinsuranceradiocharge?id=<?php echo $insured_id; ?>" class="btn btn-xs btn-danger" onclick="return confirm_delete<?php echo $insured_id; ?>()">Remove</a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                       <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                             <form action="editinsuranceradiocharge?id=<?php echo $insured_id ?>" method="POST">
   ...
   <div class="modal fade" id="addPriceModal" tabindex="-1" role="dialog" aria-labelledby="addPriceModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form action="addinsuranceradiocharge?id=<?php echo $id; ?>" method="POST">
                  <div class="form-group">
