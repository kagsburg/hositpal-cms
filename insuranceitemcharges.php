...
$id = $_GET['id'];
$ty = $_GET['ty'];
$getitem =  mysqli_query($con, "SELECT * FROM inventoryitems WHERE status=1 AND inventoryitem_id='$id'");
$row1 =  mysqli_fetch_array($getitem);
$item_id = $row1['inventoryitem_id'];
$item = $row1['itemname'];
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
   ...
   <title><?php echo $item; ?>Item Prices</title>
   <!-- Favicon icon -->
            ...
            <div class="row page-titles mx-0">
               <div class="col-sm-6 p-md-0">
                  <div class="welcome-text">
                     <h4><?php echo $item; ?> Insurance Prices</h4>
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        ...
                        <table id="example5" class="display" class="table table-striped" style="width:100%;">
                           ...
                           <tbody>
                              <?php
                              $getinsured =  mysqli_query($con, "SELECT * FROM insuredinventoryitems WHERE status=1 AND inventoryitem_id='$id'");
                              while ($row1 =  mysqli_fetch_array($getinsured)) {
                                 $insuredinventoryitem_id = $row1['insuredinventoryitem_id'];
                              ...
                              ?>
                                 <tr>
                                    ...
                                    <td>
                                       <button data-toggle="modal" data-target="#basicModal<?php echo $insuredinventoryitem_id; ?>" class="btn btn-xs btn-info">Edit</button>
                                       <a href="removeinsuranceitemcharge?id=<?php echo $insuredinventoryitem_id; ?>" class="btn btn-xs btn-danger" onclick="return confirm_delete<?php echo $insuredinventoryitem_id; ?>()">Remove</a>

                                       <script type="text/javascript">
                                          function confirm_delete<?php echo $insuredinventoryitem_id; ?>() {
                                 ...
                                 <div class="modal fade" id="basicModal<?php echo $insuredinventoryitem_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                       <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                             <form action="editinsuranceitemcharge?id=<?php echo $insuredinventoryitem_id ?>" method="POST">
   ...
   <div class="modal fade" id="addPriceModal" tabindex="-1" role="dialog" aria-labelledby="addPriceModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form action="addinsuranceitemcharge?itemid=<?php echo $id; ?>" method="POST">
                  <div class="form-group">
