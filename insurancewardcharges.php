...
$id = $_GET['id'];
$getward =  mysqli_query($con, "SELECT * FROM wards WHERE status=1 AND ward_id='$id'");
...
<head>
   ...
   <title><?php echo $ward; ?> Ward Prices</title>
   <!-- Favicon icon -->
            ...
            <div class="row page-titles mx-0">
               <div class="col-sm-6 p-md-0">
                  <div class="welcome-text">
                     <h4><?php echo $ward; ?> Insurance Prices</h4>
               ...
               <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                  <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item active"><a href="#">Ward Prices</a></li>
                  </ol>
               </div>
            </div>
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        ...
                        <table id="example5" class="display" class="table table-striped" style="width:100%;">
                           ...
                           <tbody>
                              <?php
                              $getinsured =  mysqli_query($con, "SELECT * FROM insuredwards WHERE status=1 AND ward_id='$id'");
                              while ($row1 =  mysqli_fetch_array($getinsured)) {
                                 $insuredward_id = $row1['insuredward_id'];
                              ...
                              ?>
                                 <tr>
                                    ...
                                    <td>
                                       <button data-toggle="modal" data-target="#basicModal<?php echo $insuredward_id; ?>" class="btn btn-xs btn-info">Edit</button>
                                       <a href="removeinsurancewardcharge?id=<?php echo $insuredward_id; ?>" class="btn btn-xs btn-danger" onclick="return confirm_delete<?php echo $insuredward_id; ?>()">Remove</a>

                                       <script type="text/javascript">
                                          function confirm_delete<?php echo $insuredward_id; ?>() {
                                 ...
                                 <div class="modal fade" id="basicModal<?php echo $insuredward_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                       <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                             <form action="editinsurancewardcharge?id=<?php echo $insuredward_id ?>" method="POST">
   ...
   <div class="modal fade" id="addPriceModal" tabindex="-1" role="dialog" aria-labelledby="addPriceModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form action="addinsurancewardcharge?id=<?php echo $id; ?>" method="POST">
                  <div class="form-group">
