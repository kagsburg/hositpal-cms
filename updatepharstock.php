...
<head>
    ...
    <title>Update Stock Order</title>
    <!-- Favicon icon -->
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="#">Update stock</a></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Update Stock Request </h4>
                            </div>
                            <div class="card-body">
                                <?php
                                ...
                                ?>
                                <div class="alert alert-success">Stock Request Successfully Updated</div>
                            </div>
                        </div>
