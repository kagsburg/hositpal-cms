        ...
        $(document).ready(function() {
            ...
            $(document).on("submit",".form-item",function(e) {
                ...
                $.ajax({ //make ajax request to cart_process.php
                    ...
                    $(".showit").html('<img src="assets/images/loading2.gif" alt="loading.." style="position: relative;left: 10px;">'); //show loading image
                    $(".showit").load("stockprocess.php", {
                        "load_cart": "1"
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="pharmacystock">View Stock</a></li>
                            <li class="breadcrumb-item active"><a>Request stock</a></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td> <input name="product_qty" class="form-control" type="number" form="pform<?php echo $inventoryitem_id ?>" style="width:50px">
                                                </td>
                                                <td>
                    ...
                    <div class="col-lg-5">
                        ...
                        <a href="addstockrequest" class="btn btn-primary pull-right">PROCEED <i class="fas fa-hand-point-right"></i></a>
                    </div>
