...
if (!isset($_SESSION['patientreg'])) {
    ...
    $getpatients = mysqli_query($con, "SELECT * FROM clinic_clients WHERE clinic_cl_id ='" . $_SESSION['clinic'] . "'");
                                    ...
                                    <form method="post" name='form' class="form" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-6"><label class="control-label">FullName</label>
                                                <input type="text" name="emergencyname" class="form-control " value="<?php echo $partner_name ?>" placeholder="Enter Fullname">
                                            </div>
                                            ...
                                            <div class="form-group col-lg-6"><label class="control-label">Phone Number</label>
                                                <input type="text" name="emergencyphone" class="form-control " value="<?php echo $partner_mobile ?>" placeholder="Enter  Phone Number">
                                            </div>
