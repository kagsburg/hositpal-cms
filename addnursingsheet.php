  ...
  if(strlen($patient_id)>=5){
      $pin=$patient_id;
       ...
       for($i=0;$i<$allconsumed;$i++){
        ...
        mysqli_query($con,"INSERT INTO nursingsheetmedications(nursingsheet_id,medication,consumption,frequency,admissionroot,status) VALUES('$last_id','$medications[$i]','$consumption[$i]','$frequency[$i]','$admissionroot[$i]',1)") or die(mysqli_error($con));
}  
      ...
      <div class="row">
        ...
        <div class=" col-lg-6">
          <div class="form-group">
            ...
            <div class="form-check  form-check-inline">
                <input class="form-check-input" type="radio" name="time" id="flexRadioDefault3" value="Evening">
