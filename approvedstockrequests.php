...
<head>
    ...
    <title>Approved Item Orders</title>
    <!-- Favicon icon -->
...
if((isset($_SESSION['lan']))&&($_SESSION['lan']=='fr')){ 
                                           include 'fr/approvedstockrequests.php';                     
                                       }else{
?>
       		...
       		<div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Approved item Orders</h4>
                            </div>
                            <div class="card-body">
    ...
    $getordered= mysqli_query($con, "SELECT * FROM stockorders WHERE status=1") or die(mysqli_error($con));
                   }else{      
    $allmydepts=array();
   $getmydepts= mysqli_query($con,"SELECT * FROM staffdepts WHERE staff_id='".$_SESSION['elcthospitaladmin']."'");
    ...
    $getordered= mysqli_query($con, "SELECT * FROM stockorders WHERE status=1 AND section IN($mydepts)") or die(mysqli_error($con));
                   }
