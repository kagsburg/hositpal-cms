                                    ...
                                    <?php 
                                        ...
                                        if (mysqli_num_rows($patient_reports) > 0){
                                           while($row23 = mysqli_fetch_array($patient_reports)){
                                               ...
                                               $getprevid = mysqli_query($con, "SELECT * FROM patientsque WHERE admission_id='$admission_id'  AND room IN('nurse','lab','doctor','radiography','pharmacy') and status='1' AND patientsque_id = '$previd'");
                                        ...
                                        <div class="tab-pane fade show active" id="doctorsreport" role="tabpanel">
                                            ...
                                            <table class="table  table-striped table-responsive-sm table-bordered">
                                                ...
                                                <tbody>
                                                        ...
                                                        <?php  
                                                         $nursereports = mysqli_query($con, "SELECT DISTINCT complaint, doctorreports.* FROM doctorreports WHERE patientsque_id='$patientque_id' order by `doctorreport_id` desc") or die(mysqli_error($con));
