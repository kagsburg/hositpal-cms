                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">All Credit Patients</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example5" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                            $getpatients = mysqli_query($con, "SELECT patients.*, created_at, paymethod.user_id as added_by FROM paymethod LEFT JOIN patients ON patients.patient_id=paymethod.patient_id WHERE paymethod.status='1' AND paymethod.method='credit'");
