                            ...
                            <div class="table-responsive">
                                    <table id="example5" class="display" style="min-width: 845px">
                                      <thead>
                                        ...
                                        <tbody>   
                                         <?php                                               
                                 $getque=mysqli_query($con,"SELECT * FROM patientsque WHERE payment='1' AND room='pharmacy' AND status=1");  
                                          ...
                                          <img src="images/patients/thumbs/<?php echo md5($patient_id).'.'.$ext.'?'.  time(); ?>" width="60">
                                            ...
                                            <td><?php echo $firstname.' '.$secondname.' '.$thirdname; ?></td>
                                              <td><?php echo $gender; ?></td>                                                                         
                                                   ...
                                                   <td>   
          <button data-toggle="modal" data-target="#basicModal<?php echo $patientsque_id; ?>"  class="btn btn-xs btn-info">Issued Drugs</button>             
                                        </td>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Issued Drugs</h5>
               ...
               <?php
               $issueddrugs= mysqli_query($con, "SELECT * FROM issueddrugs WHERE patientsque_id='$patientsque_id'") or die(mysqli_error($con));
               while($row= mysqli_fetch_array($issueddrugs)){
                   $drug=$row['drug'];
                   $quantity=$row['quantity'];
                  
                   $getitems=mysqli_query($con,"SELECT * FROM inventoryitems WHERE status=1 AND  inventoryitem_id='$drug'");  
                                      $row1 = mysqli_fetch_array($getitems);
               ...
               ?>     
                                 <div class="row mb-2">
                                                        <div class="col-sm-5 col-5">
                                                            <h5 class="f-w-500"><?php echo $itemname; ?><span class="pull-right">:</span>
                                                            </h5>
                                                        </div>
                                                        <div class="col-sm-7 col-7"><span><?php echo $quantity.' ('.$measurement.')'; ?></span>
                                                        </div>
                                                    </div>
               <?php }?>
