				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="medical">Medical Items</a></li>
                        </ol>
                    </div>
                </div>
       		<div class="row">
       		<div class="col-lg-12">
                    <a href="addmedical" class="btn btn-success mb-2">Add Item</a>
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">All Inventory Medical Items</h4>
                            </div>
                            <div class="card-body">
...
function confirm_delete<?php echo $inventoryitem_id; ?>() {
  return confirm('You are about To Remove this item. Are you sure you want to proceed?');
    ...
    <div class="modal fade" id="basicModal<?php echo $inventoryitem_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
          aria-hidden="true">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                           ...
                           <div class="modal-body">
                               <form method="post" name='form' class="form" action="editmedical?id=<?php echo $inventoryitem_id; ?>"  enctype="multipart/form-data">
   
                                <div class="form-group"><label class="control-label">*Trade Name</label>
                                    <input type="text" name='tradename' class="form-control" placeholder="Enter item name" required="required" value="<?php echo $tradename; ?>">                                                                          
                                </div>
                               <div class="form-group"><label class="control-label">*Generic Name</label>
                                    <input type="text" name='genericname' class="form-control" placeholder="Enter item name" required="required" value="<?php echo $genericname; ?>">                                                                          
                                </div>
