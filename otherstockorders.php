...
$roles = array('cashier', 'admin', 'accountant','receptionist','insurance officer');
...
<head>
    ...
    <title><?php echo $section ?> Stock Orders</title>
    <!-- Favicon icon -->
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4><?php echo $section ?> Stock Orders</h4>
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void()">Stock Orders</a></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example5" class="display">
                                        ...
                                        <tbody>
                                            <?php
                                            $getordered = mysqli_query($con, "SELECT * FROM stockorders WHERE status IN(1,0) AND section='$section'") or die(mysqli_error($con));
                                            ...
                                            ?>
                                                <tr class="gradeA">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="otherordereditems?id=<?php echo $stockorder_id; ?>&&st=<?php echo $status; ?>$sect=<?php $section?>" class="btn btn-primary btn-xs">Details</a>
                                                    </td>
                                                </tr>
