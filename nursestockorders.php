...
if (($_SESSION['elcthospitallevel'] != 'admin') && (($_SESSION['elcthospitallevel'] != 'pharmacist')) && (($_SESSION['elcthospitallevel'] != 'nurse') && ($_SESSION['elcthospitallevel'] != 'patron'))) {
...
<head>
    ...
    <title>Nurse Stock Orders</title>
    <!-- Favicon icon -->
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="nursestockorders">Stock Orders</a></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Nurse Stock Orders</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example5" class="display">
                                        ...
                                        <tbody>
                                            <?php
                                            $getordered = mysqli_query($con, "SELECT * FROM stockorders WHERE status IN(1,0) AND section='nurse'") or die(mysqli_error($con));
                                            ...
                                            ?>
                                                <tr class="gradeA">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="nurseordereditems?id=<?php echo $stockorder_id; ?>&&st=<?php echo $status; ?>" class="btn btn-primary btn-xs">Details</a>
                                                    </td>
                                                </tr>
