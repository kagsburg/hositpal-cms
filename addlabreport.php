                                                        ...
                                                        $count = mysqli_num_rows($getordered);
                                                            ...
                                                            if ((mysqli_num_rows($getsubtype) > 0) && ($range != 0)) {
                                                                ...
                                                                while ($row3 = mysqli_fetch_array($getsubtype)){
                                                                    ...
                                                                    <div class="form-group col-lg-6">
                                                                    <label>Test </label>
                                                                    <input type="hidden" name="test[<?php echo $investigationsubtype_id; ?>]" placeholder="Enter test" value="<?php echo $medicalservice_id; ?>">
                                                                    <input type="text" class="form-control " placeholder="Enter test" value="<?php echo $subtype; ?>" disabled>
                                                                </div>
                                                                <div class="form-group col-lg-3">
                                                                    <label>SI Unit </label>
                                                                    <input type="hidden" name="unit[<?php echo $investigationsubtype_id; ?>]" placeholder="Enter test" value="<?php echo $measurement_id; ?>">
                                                                    <input type="text" class="form-control " placeholder="Enter test" value="<?php echo $measurement; ?>" disabled>
                                                                </div>
                                                                <div class="form-group col-lg-3">
                                                                    <label>Result</label>
                                                                    <input type="number" step="0.0001"  name="result[<?php echo $investigationsubtype_id; ?>]" class="form-control " placeholder="Enter result" >
                                                                </div>
                                                                    <?php
                                                                }
                                                                ?>
                                                                ...
                                                                <button class="btn btn-primary" type="submit" name="submitspecial">Submit</button>
                                                            </div>
                                                                </form>
                                                                <?php
                                                            }
                                                            ...
                                                            <input type="hidden" name="has_answer" value="<?php echo $has_answer; ?>">
                                                                ...
                                                                <div class="form-group col-lg-5">
                                                                    <label>Result</label>
                                                                    <input type="number" step="0.0001"  name="result[<?php echo $medicalservice_id; ?>]" class="form-control " placeholder="Enter result" required>
                                                                </div>
                                                                <div class="form-group"><label class="control-label">* More Details if any</label>
                                                                        <textarea class="ckeditor" cols="70" id="editor1" rows="8" name="details"></textarea>
                                                                    </div>
