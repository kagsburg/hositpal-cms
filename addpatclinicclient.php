...
$id = $_GET['id'];
$getpatients = mysqli_query($con, "SELECT * FROM clinic_clients WHERE clinic_cl_id ='$id'");
                                ...
                                <div class="basic-form">
                                    ...
                                    if (isset($_POST['firstname'], $_POST['secondname'], $_POST['thirdname'], $_POST['gender'], $_POST['dob'], $_POST['spousename'], $_POST['spouseaddress'], $_POST['spousephone'], $_POST['phone'], $_POST['occupation'], $_POST['address'])) {
                                        ...
                                        if ((empty($firstname)) || (empty($secondname)) || (empty($gender)) || (empty($occupation)) || (empty($phone)) || (empty($address))) {
                                            ...
                                            mysqli_query($con, "INSERT INTO patients(firstname,secondname,thirdname,gender,dob,maritalstatus,spousename,spousephone,spouseaddress,religion,occupation,phone,address,email,employmentstatus,employername,employeraddress,employernumber,emergencyname,emergencyrelationship,emergencyphone,emergencyaddress,paymenttype,creditclient,insurancecompany,subscribername,socialsecuritynumber,policyidnumber,insuranceemployer,insurancedob,insurancecardext,secondarysubscribername,patientrelation,workphone,bloodgroup,weight,height,allergies,diseases,pregnancies,smoke,drink,druguse,drugtypes,exercise,specialdiet,activities,ext,docext,admin_id,timestamp,level,status,clinic) VALUES('$firstname','$secondname','$thirdname','$gender','$dob','$maritalstatus','$spousename','$spousephone','$spouseaddress','','$occupation','$phone','$address','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" . $_SESSION['elcthospitaladmin'] . "',UNIX_TIMESTAMP(),1,'2','$id')") or die(mysqli_error($con));
                                    ...
                                    <form method="post" name='form' class="form" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-lg-4"><label class="control-label">* First Name</label>
                                                <input type="text" name='firstname' class="form-control" placeholder="Enter firstname" value="<?php echo $firstname ?>" required="required">
                                            </div>
                                            <div class="form-group col-lg-4"><label class="control-label">* Second Name</label>
                                                <input type="text" name='secondname' class="form-control" placeholder="Enter second name" value="<?php echo $secondname ?>" required="required">
                                            </div>
                                        ...
                                        <div class="row forspouse" style="display: none">
                                            <div class="form-group col-lg-4"><label class="control-label">Spouse Name</label>
                                                <input type="text" name="spousename" class="form-control " value="<?php echo $partner_name ?>" placeholder="Enter Spouse Name">
                                            </div>
                                            ...
                                            <div class="form-group col-lg-4"><label class="control-label">Spouse Phone Number</label>
                                                <input type="text" name="spousephone" class="form-control " value="<?php echo $partner_mobile ?>">
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-6"><label class="control-label">* Address</label>
                                                <input type="text" name="address" class="form-control " value="<?php echo $location ?>" placeholder="Enter your Adress">
                                            </div>
