...
?>
  ...
  if(strlen($patient_id)>=4){
   ...
   <!-- <div class="form-group col-lg-12"><label class="control-label">Reason</label>
                    <textarea  name="reason_1" class="form-control" placeholder="Enter Reason" required="required" rows="4"></textarea>                                                                       
                                </div> -->
                 ...
                 <!-- <div class="form-group col-lg-12"><label class="control-label">Results</label>
                    ...
                    <!-- <div class="form-group col-lg-12"><label class="control-label">Upload Images *</label>
                    <input type="file" name="file[]" class="form-control" multiple="multiple" placeholder="Enter Results " required="required" rows="4">                                                                       
                                </div> -->
