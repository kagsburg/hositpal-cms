...
header('Location:login.php');
 ...
 if($level==5){
 header("Location:addpatient6.php");
}
}
?>
<!DOCTYPE html>
                     ...
                     <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <?php
                            if(isset($_POST['firstname'],$_POST['secondname'],$_POST['thirdname'],$_POST['gender'],$_POST['dob'],$_POST['maritalstatus'],$_POST['spousename'],$_POST['spouseaddress'],$_POST['spousephone'],$_POST['religion'],$_POST['phone'],$_POST['occupation'],$_POST['address'],$_POST['email']))  {
                            ...
                            if((empty($firstname))||(empty($secondname))||(empty($gender))||(empty($maritalstatus))||(empty($occupation))||(empty($phone))||(empty($address))){
                              echo '<div class="alert alert-danger">All Fields marked * Should be Filled</div>';
                              }
                          else{
                       mysqli_query($con,"INSERT INTO patients(firstname,secondname,thirdname,gender,dob,maritalstatus,spousename,spousephone,spouseaddress,religion,occupation,phone,address,email,employmentstatus,employername,employeraddress,employernumber,emergencyname,emergencyrelationship,emergencyphone,emergencyaddress,insurancetype,subscribername,socialsecuritynumber,policyidnumber,insuranceemployer,insurancedob,insurancecardext,secondarysubscribername,patientrelation,workphone,bloodgroup,weight,height,allergies,diseases,pregnancies,smoke,drink,druguse	,drugtypes,	exercise,specialdiet,activities,ext,docext,admin_id,timestamp,level,status) VALUES('$firstname','$secondname','$thirdname','$gender','$dob','$maritalstatus','$spousename','$spousephone','$spouseaddress','$religion','$occupation','$phone','$address','$email','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','".$_SESSION['elcthospitaladmin']."',UNIX_TIMESTAMP(),1,'1')") or die(mysqli_error($con));
                       $last_id=mysqli_insert_id($con);
  $_SESSION['patientreg']=$last_id;
  ?>
   <script type="text/javascript">
window.location = "addpatient2.php";
</script> 
 <?php
...
<input type="text"  name="spousephone" class="form-control ">
         ...
         <div class="row">                                                   
                                  <div class="form-group col-lg-6"><label class="control-label">Religion</label>
