                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="nonmedical">Non Medical Items</a></li>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add Non Medical Item</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="category" class="form-control" id="category">
                                                    ...
                                                    <?php
                                                    $getcats =  mysqli_query($con, "SELECT * FROM itemcategories WHERE status=1 AND type='Non Medical items'");
                                            ...
                                            <div class="controls">
                                                ...
                                                ?>
                                                    ...
                                                    <select name="subcategory" id="subcategory<?php echo $itemcategory_id; ?>" style="display:none;" class="subcategories form-control">
                                                        ...
                                                        ?>
                                                            <option value="savenonmedical?sub=<?php echo $subcategory_id; ?>"><?php echo $subcategory; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                <?php } ?>
