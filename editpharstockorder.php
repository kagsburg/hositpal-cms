    ...
    <script>
        $(document).ready(function() {
            ...
            $(".showit").on('click', 'a.remove-item2', function(e) {
                e.preventDefault();
                var pcode = $(this).attr("data-code"); //get product code
                var stock = $(this).attr("data-stock"); //get product code
                $(this).parent().fadeOut(); //remove item element from box
                $.getJSON("pharprocess.php", {
                    "remove_code_stock": pcode,
                    "stock": stock
                }, function(data) { //get Item count from Server
                    $("#label-info").html(data.items); //update Item count in cart-info
                    $(".showit").html('<img src="images/loading2.gif" alt="loading.." style="position: relative;left: 150px;">');
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="editpharstockorder?id=<?php echo $id ; ?>">Update stock</a></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                                ...
                                <form class="row form-item" method="post">
                                   ...
                                   $items = array();
                                    while ($row1 = mysqli_fetch_array($getitems)) {
                                        $stockitem_id = $row1['stockitem_id'];
                                        ...
                                        $type4 = $row1['type'];
                                        $measurement_id = $row33['measurement_id'];
                                        $items[] = array(
                    ...
                    <div class="col-lg-12">
                        ...
                        <a href="updatepharstock?id=<?php echo $id; ?>" class="btn btn-primary pull-right">SAVE <i class="fas fa-hand-point-right"></i></a>
                    </div>
