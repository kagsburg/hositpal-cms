        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <?php
                        $roles = array('head physican', 'admin', 'store manager');
                        if ((in_array($_SESSION['elcthospitallevel'], $roles)) && ($st == 0)) {
                        ?>
                            <a href="approveotherrequest?id=<?php echo $id; ?>&section=<?php echo $section; ?>" class="btn btn-success" onclick="return approve()"> <i class="fa fa-thumbs-up"></i> Approve Request</a>
