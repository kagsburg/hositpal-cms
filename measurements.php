...
?>
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
              ...
              mysqli_query($con,"INSERT INTO unitmeasurements(measurement,status) VALUES('$measurement',1)") or die(mysqli_error($con));
   ...
   <div class="form-group">
                     ...
                     <table id="example5" class="display" style="min-width: 600px">
                        ...
                        <td>
                         ...
                         <a href="removemeasurement?id=<?php echo $measurement_id; ?>" class="btn btn-xs btn-danger" onclick="return confirm_delete<?php echo $measurement_id;?>()">Remove</a>
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                           ...
                           <div class="modal-body">
                               <form action="editmeasurement?id=<?php echo $measurement_id; ?>" method="POST">
                                    <div class="form-group">
