...
<head>
    ...
    <title>Add Pre Natal Consultation</title>
    <!-- Favicon icon -->
...
include 'includes/header.php';
   if((isset($_SESSION['lan']))&&($_SESSION['lan']=='fr')){ 
                                           include 'fr/addprenatalreport.php';                     
                                       }else{
?>
				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Add Pre Natal Consultation</h4>
   ...
   ?>
     <form method="post" name='form' class="form" action=""  enctype="multipart/form-data">      
               ...
               <div class="form-group col-lg-6">
                           ...
                           <div class="form-group col-lg-6">
                               <label class=" control-label">Age Gross</label>                          
                               <input type="text" class="form-control" name="agegross">
                                                        </div>
                         <div class="form-group col-lg-6">
                               <label class=" control-label">Gesture</label>                          
                               <input type="text" class="form-control" name="gesture">
                                                        </div>
                         <div class="form-group col-lg-6">
                               <label class=" control-label">Parity</label>                          
  ...
  <label class="form-check-label" for="inlineCheckbox2">Already on ARVs?</label>
                    ...
                    <div class="form-group col-lg-6 mb-4">
                <div class="form-check form-check-inline">
    <input class="form-check-input" type="checkbox" value="yes" name="recommended">
  <label class="form-check-label" for="inlineCheckbox2">Recommended for HIV testing?</label>
</div>
</div> 
             <div class="form-group col-lg-6 mb-4">
                <div class="form-check form-check-inline">
    <input class="form-check-input" type="checkbox" value="yes" name="testing">
  <label class="form-check-label" for="inlineCheckbox2">HIV testing?</label>
</div>
</div> 
            <div class="form-group col-lg-6 mb-4">
                <div class="form-check form-check-inline">
