...
$id = $_GET['id'];
$getmedicalservice =  mysqli_query($con, "SELECT * FROM medicalservices WHERE status IN (1,2) AND medicalservice_id='$id'");
...
<head>
    ...
    <title><?php echo $medicalservice; ?> Service Prices</title>
    <!-- Favicon icon -->
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4><?php echo $medicalservice; ?> Insurance Prices</h4>
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="#">Service Prices</a></li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table id="example5" class="display" class="table table-striped" style="width:100%;">
                                    ...
                                    <tbody>
                                        <?php
                                        $getinsured =  mysqli_query($con, "SELECT * FROM insuredservices WHERE status=1 AND medicalservice_id='$id'");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="removeinsurancecharge?id=<?php echo $insuredservice_id; ?>" class="btn btn-xs btn-danger" onclick="return confirm_delete<?php echo $insuredservice_id; ?>()">Remove</a>
                                            ...
                                            <div class="modal fade" id="basicModal<?php echo $insuredservice_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="editinsurancecharge?id=<?php echo $insuredservice_id ?>" method="POST">
    ...
    <div class="modal fade" id="addPriceModal" tabindex="-1" role="dialog" aria-labelledby="addPriceModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form action="addinsuranceservicecharge?id=<?php echo $id; ?>" method="POST">
                  <div class="form-group">
