    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        if ((isset($_SESSION['lan'])) && ($_SESSION['lan'] == 'fr')) {
            include 'fr/getincomereport.php';
        } else {
        ?>
                    ...
                    <div class="row page-titles mx-0">
                        ...
                        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="getincomereport">Get Report</a></li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Get Income Report</h4>
                                </div>
                                <div class="card-body">
