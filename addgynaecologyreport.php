...
<head>
    ...
    <title>Add Gynaecology Report</title>
    <!-- Favicon icon -->
...
include 'includes/header.php';
   if((isset($_SESSION['lan']))&&($_SESSION['lan']=='fr')){ 
                                           include 'fr/addgynaecologyreport.php';                     
                                       }else{
?>
				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="#">Add Gynaecology Report</a></li>
                        </ol>
                    </div>
                </div>
       	<div class="row">
      ...
      $pin=$patient_id;
                    ...
                    <div class="col-lg-3">
                     ...
                     <div class="col-lg-9">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add Gynaecology Report</h4>
                            </div>
                            <div class="card-body">
            ...
            mysqli_query($con, "INSERT INTO gynaecologyreports(patientsque_id,month,year,reason,description,results,conclusion,responsible,admin_id,timestamp,status) VALUES('$id','$month','$year','$reason','$description','$results','$conclusion','$responsible','".$_SESSION['elcthospitaladmin']."',UNIX_TIMESTAMP(),1)") or die(mysqli_error($con));
