                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    if (isset($_POST['details'])) {
                                        ...
                                        if (isset($_POST['test'], $_POST['result'])) {
                                            ...
                                            foreach($test as $key => $value){
                                                ...
                                                mysqli_query($con, "INSERT INTO labreports(test,result,patientsque_id,clinic,details,status) VALUES('$test_id','$result_id','$patient_id',1,'$details','1')") or die(mysqli_error($con));
                                            }
                                            // mysqli_query($con, "UPDATE clinic_clients SET status='1' WHERE clinic_cl_id='$patient_id'") or die(mysqli_error($con));
                                    ...
                                    <?php
                                     ...
                                     echo '<script>window.location.href = "clinicwaiting.php?ty=lab";</script>';
                                    ...
                                    <form method="post" name='form' class="form" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-12">
                                            <div class='subobj1'>
                                                <?php 
                                                $total = 0;
                                                    $getorder = mysqli_query($con, "SELECT * FROM laborders WHERE  patientsque_id='$patient_id' and source='clinic'");
