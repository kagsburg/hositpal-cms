                                          ...
                                          <img src="images/patients/thumbs/<?php echo md5($patient_id).'.'.$ext.'?'.  time(); ?>" width="60">
                                            ...
                                            <td><?php echo $firstname.' '.$secondname.' '.$thirdname; ?></td>
                                              ...
                                              <td><?php echo $fullname; ?></td>                                
                                                   ...
                                                   <td>   
          <button data-toggle="modal" data-target="#basicModal<?php echo $patientsque_id; ?>"  class="btn btn-xs btn-info">Lab Report</button>             
                                        </td>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
               ...
               <?php
               $labreports= mysqli_query($con, "SELECT * FROM labreports WHERE patientsque_id='$patientsque_id'") or die(mysqli_error($con));
               ...
               ?>     
                                 <div class="row mb-2">
                                                        ...
                                                        <div class="col-sm-7 col-7"><span><?php echo $result; ?></span>
                                                        </div>
                                                    </div>
               <?php }?>
