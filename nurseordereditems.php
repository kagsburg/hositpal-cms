        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <?php
                        if (($_SESSION['elcthospitallevel'] == 'pharmacist') && ($st == 0)) {
                        ?>
                            <a href="approvenurserequest?id=<?php echo $id; ?>" class="btn btn-success" onclick="return approve()"> <i class="fa fa-thumbs-up"></i> Approve Request</a>
