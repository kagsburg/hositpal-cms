                            ...
                            <div class="card-body">
                                <?php
                                  if (isset($_SESSION["bproducts"]) && count($_SESSION["bproducts"]) > 0) {
                                    ...
                                    mysqli_query($con, "INSERT INTO stockorders(section,reason,type,admin_id,timestamp,status) VALUES('cashier,'0','".$_SESSION["bproducts"]['type']."','" . $_SESSION['elcthospitaladmin'] . "',UNIX_TIMESTAMP(),0)") or die(mysqli_error($con));
                                    ...
                                    foreach ($_SESSION["bproducts"] as $product) { //loop though items and prepare html content
                                        ...
                                        mysqli_query($con, "INSERT INTO ordereditems(stockorder_id,item_id,quantity,section) VALUES('$last_id','$item_id','$product_qty','cashier')") or die(mysqli_error($con));
