                     ...
                     <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">PART SIX</h4>
                            </div>
                            <div class="card-body">
...
mysqli_query($con,"UPDATE patients SET ext='$image_ext',docext='$doc_ext',level=6 WHERE patient_id='".$_SESSION['patientreg']."'");
  if(!empty($image_name)){
...
echo '<div class="alert alert-success">Patient Information Successfully Added.Click <a href="patients">here</a> to view Patients</div>';
