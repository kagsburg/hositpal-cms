                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">PART FIVE</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <?php
                                    if (isset($_FILES['image'], $_FILES['doc'])) {
                                        ...
                                        mysqli_query($con, "UPDATE patients SET ext='$image_ext',docext='$doc_ext',level=6,status=1 WHERE patient_id='" . $_SESSION['patientreg'] . "'");
                                        if (!empty($image_name)) {
