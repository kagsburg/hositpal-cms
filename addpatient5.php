                                ...
                                <?php
                                    if (isset($_POST['submit'])) {
                                        ...
                                        if (!empty($errors)) {
                                            ...
                                            mysqli_query($con, "UPDATE patients SET paymenttype='$paymenttype',insurancecompany='',policyidnumber='',level='5' WHERE patient_id='" . $_SESSION['patientreg'] . "'") or die(mysqli_error($con));
