...
<head>
    ...
    <title>Approved Medication Orders</title>
    <!-- Favicon icon -->
				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Approved Medication Orders</h4>
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="approvednurseorders">Approved Orders</a></li>
                        </ol>
                    </div>
                </div>
       		<div class="row">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Approved Nurse Orders</h4>
                            </div>
                            <div class="card-body">
                       ...
                       $getorders= mysqli_query($con,"SELECT * FROM nurseorders WHERE status=1 AND admin_id='".$_SESSION['elcthospitaladmin']."'") or die(mysqli_error($con));
                        }else{
                          $getorders= mysqli_query($con,"SELECT * FROM nurseorders WHERE status=1") or die(mysqli_error($con));    
                        }
